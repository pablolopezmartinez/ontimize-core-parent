...
public class DefaultMailManager extends AbstractMailManager {
    ...
    public DefaultMailManager(String mailserver, String userN, String password, boolean useAuth)
    ...
    public DefaultMailManager(Properties prop) throws IllegalArgumentException {
        ...
        if (userN == null) {
            ...
            if (passw == null) {
                ...
                this.setAuthenticator(
                        new AbstractMailManager.SilentAuthenticator(this.getUserName(), passw.toString()));
            }
        }
        ...
        if (socketfactoryclass != null) {
            if (socketfactoryclass.toString().equalsIgnoreCase("yes")
                    || socketfactoryclass.toString().equalsIgnoreCase("true")) {
