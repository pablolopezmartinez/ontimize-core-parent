...
public abstract class FileUtils {
    ...
    public static boolean saveANSIFile(java.awt.Frame f, String dialogTitle, String contents, String extension,
            ResourceBundle resoruces) throws Exception {
        ...
        while (true) {
            ...
            if (option != JFileChooser.APPROVE_OPTION) {
                int resp = MessageDialog.showMessage(f, "fileutils.cancel_file_saving_operation", null,
                ...
                if (archivoSel.exists()) {
                    int resp = MessageDialog.showMessage(f, "fielddata.overwrite_existing_file", null,
                            JOptionPane.QUESTION_MESSAGE, JOptionPane.YES_NO_OPTION, resoruces);
    ...
    public static void saveJPEGImage(java.awt.Image im, OutputStream out) throws IOException {
        try {
            BufferedImage bi = new BufferedImage(im.getWidth(FileUtils.fc), im.getHeight(FileUtils.fc),
