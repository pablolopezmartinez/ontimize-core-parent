...
public class FormUpdateSharedReference extends EJDialog implements Internationalization {
	 ...
	 * @param modal
	 *            -> To specify if the dialog will be opened in a model form,
	 *            blocking the other parts of application
	 * @param locator
	 *            -> Locator, needed to obtain the remote references to the
	 *            sharing systems
	 * @param p
	 *            -> Point where the dialog opens (top-left corner)
	 * @param share
	 *            -> Share element to update
	 * @throws Exception
	 */
	public FormUpdateSharedReference(Window owner, boolean modal, EntityReferenceLocator locator, Point p, SharedElement share) throws Exception {
	...
	/**
	 * Create and return the TextDataField that has the content to share. This
	...
	/**
	 * Create and return the cancel button. This button is used to ensure that
	 * the variable <code>updateShare</code> to false.
	 *
	...
	/**
	 * Create and return the accept button. This button must to ensure that the
	 * variable <code>updateShare</code> is set to <code>true</code>, and save
	 * the name, content and message of the form into the form variables
	 * <code>name</code>, <code>defaultMessage</code> and
	...
	protected Button createAndConfigureButtonAccept() {
		...
		acceptButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if (!FormUpdateSharedReference.this.nameDataField.isEmpty() && !FormUpdateSharedReference.this.contentShareDataField.isEmpty()
					...
					FormUpdateSharedReference.this.contentShare = FormUpdateSharedReference.this.contentShareDataField.getValue();
					FormUpdateSharedReference.this.defaultMessage = FormUpdateSharedReference.this.memoDataField.getText();
					FormUpdateSharedReference.this.dispose();
				} else {
	...
	/**
	 *
	 * @return The status of the update, <code>true</code> if the component is
	 *         ready to update (accept button), or <code>false</code> otherwise
	 */
