...
public interface TemplateGenerator {
	 ...
	 *
	 * @param resource
	 *            : Resource where the template is located.
	 * @param valuesDescriptions
	...
	public File fillDocument(String resource, Hashtable valuesDescriptions, Hashtable valuesTable, Hashtable valuesImages) throws Exception;

	public File fillDocument(String resource, Hashtable valuesDescriptions, Hashtable valuesTable, Hashtable valuesImages, Hashtable valuesPivotTable) throws Exception;
	 ...
	 *            : Template to fill.
	 * @param nameFile
	 *            : Name used to save the filled template
	 * @param fieldValues
	 *            : This object contains the data field values to insert in the template. Keys must be the field names and values must have the data field values to insert.
	 * @param valuesTable
	...
	public File fillDocument(InputStream input, String nameFile, Hashtable fieldValues, Hashtable valuesTable, Hashtable valuesImages, Hashtable valuesPivotTable) throws Exception;
