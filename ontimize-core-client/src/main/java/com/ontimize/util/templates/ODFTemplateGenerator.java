...
public class ODFTemplateGenerator extends AbstractTemplateGenerator {
    ...
    public File fillDocument(String resource, Hashtable fieldValues, Hashtable valuesTable, Hashtable valuesImages,
        ...
        File f = this.fillDocument(input, FileUtils.getFileName(resource), fieldValues, valuesTable, valuesImages,
                valuesPivotTable);
        input.close();
        return f;
    }
    ...
    /**
     * Create a copy of the parameter hashtable to parse the containing dates with the current date
     * format parser.
     * @param h Hashtable to parse.
    ...
    private byte[] createImageBytes(Object o) throws Exception {
        ...
        if (o instanceof ByteArrayOutputStream) {
            ...
            if (img instanceof RenderedImage) {
                ...
                BufferedImage bim = new BufferedImage(img.getWidth(null), img.getHeight(null),
