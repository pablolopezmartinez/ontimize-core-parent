/*
 * @(#)Constants.java 1.8 03/01/23 Copyright 2003 Sun Microsystems, Inc. All rights reserved. SUN
 * PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 */
package com.ontimize.util.rtf;

/**
 * Class to hold dictionary keys used by the RTF reader/writer. These should be moved into
 * StyleConstants.
 */
class Constants {
