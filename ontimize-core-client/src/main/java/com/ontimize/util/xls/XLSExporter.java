...
public interface XLSExporter {
	...
	/**
	 * Creates a *.xls file with the {@link EntityResult} content in the
	 * {@link File} indicated. If the parameter {@code openFile} is
	 * {@code true}, opens the file at the end of the export
	 *
	 * @param rs
	 *            {@link EntityResult} EntityResult with the data to export
	 * @param output
	 *            {@link File} The file where the documente will be saved
	 * @param sheetName
	 ...
	 *            headers
	 * @param openFile
	 *            {@link Boolean} Boolean indicating whether to open the file at
	 *            the end of the export or not.
	 * @throws Exception
	 */
	 ...
	 * the {@link File} indicated depending on whether the {@code xslx}
	 * parameter is {@code true} or not. If the parameter {@code openFile} is
	 * {@code true}, opens the file at the end of the export.
	 *
	 * @param rs
	 *            {@link EntityResult} EntityResult with the data to export
	...
	/**
	 * Creates a *.xls file with the {@link EntityResult} content in the
	 * {@link File} indicated. This contains a specific {@link Workbook} and the
	 * name of the sheet. If the parameter {@code openFile} is {@code true},
	 * opens the file at the end of the export
	 *
	 * @param rs
	 *            {@link EntityResult} EntityResult with the data to export
	 * @param output
	...
	/**
	 * Creates a *.xls file with the {@link EntityResult} content in the
	 * {@link File}. This contains a specific {@link Workbook} and the name of
	 * the sheet. If the parameter {@code openFile} is {@code true}, opens the
	 * file at the end of the export
	 *
	 * @param rs
	 *            {@link EntityResult} EntityResult with the data to export
	 * @param output
