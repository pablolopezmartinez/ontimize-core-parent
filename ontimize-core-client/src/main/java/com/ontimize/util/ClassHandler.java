...
public class ClassHandler {
	 ...
	 *
	 * @param className
	 *            The class name of the {@link Class} object.
	 ...
	 *            If true, return the {@link Class} for Java primitive types.
	 * @return {@link Class} object for the given <code>className</code>.
	 */
	...
	/**
	 * <p>
	 * Returns the {@link Method} of the given Object <code>source</code> with the given <code>name</code>.
	 *
	 * @param source
	...
	/**
	 * <p>
	 * Returns the {@link Method} of the given Object <code>source</code> with the <code>name</code> and the parameter <code>class</code>.
	 *
	 * @param source
	 *            Object with the method.
	 * @param name
	 *            of the method to return.
	 * @param clazz
	 *            Array with the {@link Class} paramters of the method.
	...
	/**
	 * <p>
	 * Returns the given {@link String} <code>value</code> converted into the <code>className</code> {@link Class}.
	 *
	 * <p>
	 * Some classes have a custom converter, else the default converter uses the contructor class with the String parameter (a {@link IllegalArgumentException} can be thrown).
	 *
	 * @param className
	 *            The class name of the returned object value.
	 * @param value
