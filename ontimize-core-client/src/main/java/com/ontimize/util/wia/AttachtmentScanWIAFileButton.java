...
public class AttachtmentScanWIAFileButton extends TableButton {
	 ...
	 *            process and blocks the application until the attachment finishes.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>scanSound</td>
	 *            <td><i>String</td>
	 ...
	 * @throws Exception
	 */
	public AttachtmentScanWIAFileButton(Hashtable params) throws Exception {
		...
		super.addActionListener(new AttachmentScanWIAFileAction(this.entity, this.scanAddDescription, this.scanRefreshForm, bWait, uriSound));
