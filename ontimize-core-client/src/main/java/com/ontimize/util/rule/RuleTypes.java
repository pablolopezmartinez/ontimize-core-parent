...
public class RuleTypes {
    ...
    protected static List dataComponentEventTypes = Arrays
        .asList(new String[] { RuleParser.Attributes.VALUE_TYPE_EVENT });
    ...
    protected static List actionTypes = Arrays
        .asList(new String[] { RuleParser.Attributes.SET_VALUE_ACTION, RuleParser.Attributes.SET_ENABLED_ACTION,
