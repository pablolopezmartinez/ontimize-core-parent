...
public class Toast extends JPanel {
    ...
    private void initComponents() {
        ...
        this.add(label, new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(30, 20, 30, 20), 0, 0));
    }
    ...
    protected static Color[] borderColors = new Color[] { ParseUtils.getColor("#0000000F", Color.black),
            ParseUtils.getColor("#0000001E", Color.black), ParseUtils
                .getColor("#0000002D", Color.black),
            ParseUtils.getColor("#0000003C", Color.black), ParseUtils.getColor("#0000004B", Color.black), };
    ...
    protected class ContentDialog extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            Shape center = new RoundRectangle2D.Float(insets.left, insets.top,
                    this.getWidth() - insets.left - insets.right, this.getHeight() - insets.top - insets.bottom, 10,
                    10);
            g.setColor(color);
