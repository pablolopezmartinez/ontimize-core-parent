...
public class StretchIcon extends ImageIcon {
     ...
     * @param imageData an array of pixels in an image format supported by the AWT Toolkit, such as GIF,
     *        JPEG, or (as of 1.3) PNG
     *
     ...
     * @param imageData an array of pixels in an image format supported by the AWT Toolkit, such as GIF,
     *        JPEG, or (as of 1.3) PNG
     * @param proportionate <code>true</code> to retain the image's aspect ratio, <code>false</code> to
     *        allow distortion of the image to fill the component.
     *
     * @see ImageIcon#ImageIcon(byte[])
     */
     ...
     * <P>
     * If the proportion has not been specified, or has been specified as <code>true</code>, the aspect
     * ratio of the image will be preserved by padding and centering the image horizontally or
