...
public class PrintPreviewDialog extends JComponent {
	...
	protected class Page extends JComponent implements Scrollable {
		...
		public Dimension getPreferredSize() {
			return new Dimension((int) (this.pf.getWidth() * this.zoom) + this.getInsets().left + this.getInsets().right,
		...
		public void paintComponent(final Graphics g2d) {
			try {
				...
				PrintPreviewDialog.this.rp.getPrintable(PrintPreviewDialog.this.pageNumber).print(newG, this.pf, PrintPreviewDialog.this.pageNumber);
	...
	public PrintPreviewDialog(Pageable r, PageFormat pf, String jobnam) {
		...
		CompoundBorder border = new CompoundBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10), BorderFactory.createLineBorder(Color.lightGray, 1));
