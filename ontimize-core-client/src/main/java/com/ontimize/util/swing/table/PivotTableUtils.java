...
public class PivotTableUtils extends JPanel {
    ...
    public static class RowHeaderRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
            ...
            if (row > 0) {
                ...
                boolean bEquals = ((vant == null) && (value == null))
    ...
    public static class HeaderRenderer extends HeadCellRenderer implements Internationalization {
        ...
        public Object getRenderedValue(JTable table, Object value, boolean isSelected, boolean hasFocus, int row,
                int column) {
            if ("table.total".equals(value)) {
    ...
    public static class NumberRenderer extends DefaultTableCellRenderer {
        ...
        protected Object createPreProcess(JTable table, Object value, boolean isSelected, boolean hasFocus, int row,
                int column) {
        ...
        protected Component createPostProcess(Component c, JTable table, Object value, boolean isSelected,
    ...
    public static class PivotDialog extends AJDialog {
        ...
        public PivotDialog(Frame owner, TableModel model, ResourceBundle res, Hashtable parameters,
                String originalColPosAndWith) {
        ...
        public PivotDialog(Dialog owner, TableModel model, ResourceBundle res, Hashtable parameters,
                String originalColPosAndWith) {
            super(owner, PivotTableUtils.translate(PivotDialog.PIVOT_DIALOG_TITLE, res, null), true);
            this.init(model, res, parameters, originalColPosAndWith);
        }
    ...
    public static class PivotPanel extends JPanel {
        ...
        protected void configureExportExcelButton() {
            ...
            this.exportExcelButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent actionEvent) {
                    ...
                    javax.swing.filechooser.FileFilter ffText = FileUtils.getExtensionFileFilter("text_files",
                            new String[] { "txt" });
                    javax.swing.filechooser.FileFilter ffExcel = FileUtils
                        ...
                        if (obj instanceof JTable) {
                            ...
                            if (model instanceof ITotalDetailTableModel) {
                                ...
                                try {
                                    ...
                                    Hashtable information = ((ITotalDetailTableModel) model)
            ...
            try {
                if (this.updateEnabled) {
                    ...
                    if (rowFields.isEmpty() || columnFields.isEmpty() || dataFields.isEmpty()) {
                        ...
                        TableModel pModel = PivotPanel.create(this.model, rows, column, dataColumn,
        ...
        public static TableModel create(TableModel orig, String[] rows, String column, String dataColumn, int operation,
                int dategroup) {
            return PivotPanel.create(orig, rows, column, dataColumn, operation, dategroup, null);
        }

        public static TableModel create(TableModel orig, String[] rows, String column, String dataColumn, int operation,
                int dategroup, Hashtable comparators) {
            if (dataColumn == null) {
    ...
    public static JDialog createPivotDialog(Window w, TableModel model, ResourceBundle res, Hashtable parameters,
            String originalColPosAndWith) {
        PivotDialog pd = null;
        if (w instanceof Dialog) {
    ...
    public static class FixedColumnTable extends JSplitPane implements ChangeListener, PropertyChangeListener {
        ...
        protected int getPreferredColumnWidth(JTable table, int modelColumnIndex, int maxRowNumber) {
            ...
            try {
                ...
                Component hederRendererComponent = headerRenderer.getTableCellRendererComponent(table, oHeaderValue,
                        false, false, 0, 1);
