...
/**
 * A label, that can be rotate periodically. Thus the reading direction is either horizontal (the default), up or down.
 *
 */
...
public class RotatedLabel extends JLabel {
	...
	/**
	 * Initialises a new instance of the {@link RotatedLabel} class using the specified icon and horizontal alignment.
	 *
	 * @param image
	...
	public void init() {
		this.timer = new Timer(RotatedLabel.defaultTimerPeriod, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				RotatedLabel.this.currentRotation = (RotatedLabel.this.currentRotation + RotatedLabel.defaultRotationIncrement) % 360;
