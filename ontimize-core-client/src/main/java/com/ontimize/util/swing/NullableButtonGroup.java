...
/**
 * This class implements a ButtonGroup. Originally, this component always tries to select one of the components (radio buttons typically) placed inside. With this class is allowed
 * null selection (a non-visible radio button is selected).
 *
