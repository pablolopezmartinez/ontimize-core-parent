...
public class ButtonSelection extends JComponent {
	...
	protected void init(boolean highlight) {
		...
		this.add(this.button, new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		this.add(this.menuButton, new GridBagConstraints(1, 0, 1, 1, 0, 1, GridBagConstraints.WEST, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
	...
	protected class Action extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if (ButtonSelection.this.getMenu() != null) {
				...
				ButtonSelection.this.getMenu().show(ButtonSelection.this.button, 0, ButtonSelection.this.button.getHeight());
		...
		public Dimension getPreferredSize() {
			...
			if (ApplicationManager.useOntimizePlaf) {
				if (this.dimension == null) {
					...
					this.dimension = new Dimension(ButtonSelection.defaultArrowButtonWidth, super.getPreferredSize().height);
				}
