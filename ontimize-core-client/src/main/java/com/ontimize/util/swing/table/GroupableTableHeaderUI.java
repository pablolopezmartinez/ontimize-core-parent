...
public class GroupableTableHeaderUI extends BasicTableHeaderUI implements Internationalization {
    ...
    private void paintCell(Graphics g, Rectangle cellRect, int columnIndex) {
        ...
        Component component = renderer.getTableCellRendererComponent(this.header.getTable(), aColumn.getHeaderValue(),
    ...
    private void paintGroupCell(Graphics g, Rectangle cellRect, GroupableColumnGroup cGroup,
    ...
    private void paintBackgroundCell(Graphics g, Rectangle cellRect, int columnIndex, TableCellRenderer renderer) {
        if (renderer instanceof IGroupableTableHeaderCellRenderer) {
            Component c = ((IGroupableTableHeaderCellRenderer) renderer).getTableHeaderBackgroundCellRendererComponent(
    ...
    private int getHeaderHeight() {
        ...
        for (int column = 0; column < columnModel.getColumnCount(); column++) {
            ...
            Component comp = renderer.getTableCellRendererComponent(this.header.getTable(), aColumn.getHeaderValue(),
