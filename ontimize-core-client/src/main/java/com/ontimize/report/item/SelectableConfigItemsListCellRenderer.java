...
public class SelectableConfigItemsListCellRenderer extends JPanel implements ListCellRenderer {
    ...
    public SelectableConfigItemsListCellRenderer() {
        ...
        this.add(this.checkbox, new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.CENTER,
                GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        this.add(this.configButton, new GridBagConstraints(1, 0, 1, 1, 0, 1, GridBagConstraints.EAST,
