...
public class OrderWindow extends EJDialog implements Internationalization {
	...
	public java.util.List showOrderWindow(java.util.List selectedColumnList, java.util.List groupList, java.util.List sortColumnList) {
	...
	private void setOrderColumns(java.util.List sortColumnList, java.util.List selectedColumnList, java.util.List groupList) {
		DefaultListModel model = (DefaultListModel) this.l.getModel();
	...
	protected void init() {
		...
		this.l.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				DefaultReportDialog.checkListStatusButtons(OrderWindow.this.l, OrderWindow.this.allUpButton, OrderWindow.this.upButton, OrderWindow.this.downButton,
		...
		jpButtonsPanel2.add(this.acceptButton, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		jpButtonsPanel2.add(this.cancelButton, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		jpButtonsPanel2.setBorder(new EmptyBorder(3, 3, 3, 3));
		panelInterno.add(jpButtonsPanel2, BorderLayout.SOUTH);
		aux.add(panelInterno);
		this.pack();
		DefaultReportDialog.checkListStatusButtons(this.l, this.allUpButton, this.upButton, this.downButton, this.allDownButton);
	}
