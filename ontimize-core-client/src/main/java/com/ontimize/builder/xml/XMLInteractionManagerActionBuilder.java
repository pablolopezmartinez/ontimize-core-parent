 ...
 */
public class XMLInteractionManagerActionBuilder extends com.ontimize.xml.XMLInterpreter
        implements com.ontimize.builder.InteractionManagerActionBuilder {
    ...
    protected InteractionManagerAction createManager(Node node) {
        ...
        try {
            ...
            XMLInteractionManagerActionBuilder
                .warning(XMLInteractionManagerActionBuilder.MSG_CREATE_MANAGER_CLASS_NULL + name);
        } catch (ClassCastException cce) {
            XMLInteractionManagerActionBuilder.logger.trace(null, cce);
            XMLInteractionManagerActionBuilder
                .warning(XMLInteractionManagerActionBuilder.MSG_CREATE_MANAGER_CLASS_INVALID + name);
        } catch (Exception ex) {
            XMLInteractionManagerActionBuilder.logger.trace(null, ex);
            XMLInteractionManagerActionBuilder.warning(ex);
        }
    ...
    protected ModeAction createAction(Node node) {
        ...
        try {
            ...
            ModeAction action = new BasicInteractionManagerAction.BasicModeAction(nameValue, attrValue, classValue,
                    valueValue);
            return action;
        } catch (Exception ex) {
            XMLInteractionManagerActionBuilder.warning(ex);
    ...
    protected ListenerItem createListenerItem(Node node) {
        ...
        try {
            ...
            Node classNode = nnm != null ? nnm.getNamedItem(XMLInteractionManagerActionBuilder.LISTENER_CLASS_KEY)
                    : null;
            ...
            ListenerItem li = new BasicInteractionManagerAction.BasicListenerItem(idValue, attrValue, classValue,
                    nameValue);
            return li;
        } catch (Exception ex) {
            XMLInteractionManagerActionBuilder.warning(ex);
