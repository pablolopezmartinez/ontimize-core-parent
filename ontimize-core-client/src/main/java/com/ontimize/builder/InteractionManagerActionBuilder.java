...
public interface InteractionManagerActionBuilder {
	...
	/**
	 * <p>
	 * Loads a XML content from the given {@link String} <code>resource</code>
	 * and creates a {@link InteractionManagerAction} action model.
	 *
	 * @param resource
	 *            {@link InputStream} XML source.
	...
	/**
	 * <p>
	 * Loads a XML content from the given {@link InputStream}
	 * <code>resource</code> and creates a {@link InteractionManagerAction}
	 * action model.
	 *
	 * @param resource
	 *            {@link InputStream} XML source.
