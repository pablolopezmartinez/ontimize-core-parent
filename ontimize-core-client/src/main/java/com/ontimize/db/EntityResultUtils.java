...
public abstract class EntityResultUtils extends EntityResultTools {
    ...
    public static class EntityResultTableModel extends AbstractTableModel {
        ...
        public EntityResultTableModel(EntityResult res, boolean returnEmptyStrings, boolean convertBytesBlockToIm,
    ...
    public static TableModel createTableModel(EntityResult res, Vector cols, boolean returnEmptyStrings,
            boolean convertBytesBlockToIm, boolean convertBooleanToIm) {
        EntityResult resN = new EntityResult();
    ...
    /**
     * @param res Values of this object must be Vector elements
     * @return
     */
    ...
    public static EntityResult merge(EntityResult r1, EntityResult r2) {
        ...
        EntityResult res1 = r1.deepClone();
    ...
    /**
     * Combines all data in the Hashtable h and the EntityResult r2. The combination is done in the next
     * way:<BR>
     * - All pairs (key-value) in the Hashtable h are added in each record of r2.<BR>
    ...
    public static EntityResult combine(Hashtable h, Hashtable h2) {
        EntityResult rAux = new EntityResult();
        rAux.putAll(h2);
    ...
    public static void addColumn(EntityResult entityResult, String columnName) {
        if (!entityResult.containsKey(columnName)) {
            ...
            columnRecords.setSize(entityResult.calculateRecordNumber());
    ...
    public static class EntityResultSorter {
        ...
        public void sort() {
            ...
            EntityResult.logger.debug("Sorting of an array of {} records from 0 up to {}", this.indexes.length,
