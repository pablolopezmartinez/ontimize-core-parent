...
public class SelectOutputColumns extends EJDialog implements ActionListener {
	...
	public void init(String[] columns, boolean[] queryColumns, ResourceBundle bundle) {
		...
		this.getContentPane().add(new JLabel(ApplicationManager.getTranslation("QueryBuilderOuputColumnsElegirColsConsulta", bundle)),
				new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		this.getContentPane().add(sp, new GridBagConstraints(0, 1, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		this.getContentPane().add(jpButtons, new GridBagConstraints(0, 2, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
		this.pack();
	}
