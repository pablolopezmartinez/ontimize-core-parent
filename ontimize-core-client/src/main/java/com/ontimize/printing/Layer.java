...
public class Layer {
	 ...
	 * @param height
	 * @param pixels
	 *            If this is true then width and height are values in pixels in other case they are a percentage
	 * @param align
	 */
	public Layer(String id, int width, int height, boolean pixels, String align) {
		if (pixels) {
			this.startTag = "<DIV id='" + id + "'" + align + " style='width:" + Integer.toString(width) + ";height:" + Integer.toString(height) + "'>";
		} else {
			this.startTag = "<DIV id='" + id + "'" + align + " style='width:" + Integer.toString(width) + "%;height:" + Integer.toString(height) + "%'>";
		}
		this.endTag = "</DIV>";
	 ...
	 * @param align
	 * @param leftMargin
	 *            Used to locate the layer at the left side of the page
	 */
	public Layer(String id, int width, int height, boolean pixels, String align, int leftMargin) {
		if (pixels) {
			this.startTag = "<DIV id='" + id + "'" + align + " style='width:" + Integer.toString(width) + ";height:" + Integer
					.toString(height) + ";margin-left:" + leftMargin + "'>";
		} else {
			this.startTag = "<DIV id='" + id + "'" + align + " style='width:" + Integer.toString(width) + "%;height:" + Integer
					.toString(height) + "%;margin-left:" + leftMargin + "'>";
		}
