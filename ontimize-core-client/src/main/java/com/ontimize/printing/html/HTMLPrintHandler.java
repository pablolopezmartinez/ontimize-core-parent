...
public class HTMLPrintHandler {
    ...
    class HTMLPrintable implements Printable {
        ...
        public Vector createTransforms(JEditorPane jeditorpane, PageFormat pageformat) {
            ...
            Rectangle rectangle = HTMLPrintHandler.getViewRect(view, (float) pageformat.getImageableWidth(),
            ...
            Rectangle2D.Double var_double = new Rectangle2D.Double(0.0, 0.0, pageformat.getImageableWidth(),
        ...
        public int print(Graphics graphics, PageFormat pageformat, int i) {
            ...
            if (graphics2d.getClip() == null) {
                ...
                Rectangle2D.Double var_double = new Rectangle2D.Double(pageformat.getImageableX(),
            ...
            if (d_14_ > 0.0) {
                ...
                Rectangle2D.Double var_double = new Rectangle2D.Double(rectangle2d.getX(), rectangle2d.getY(),
