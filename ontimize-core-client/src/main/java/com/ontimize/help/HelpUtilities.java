...
public class HelpUtilities {
	...
	/**
	 * It indicates whether default ontimize help files are included in help dialog. By default, it is true.
	 */
	...
	public static void recheck() {
		try {
			...
			UIManager.getDefaults().put("HelpContentViewerUI", "com.ontimize.help.HelpUtilities$ModifiedHelpContentViewerUI");
			...
			HelpUtilities.logger.debug("HelpUtilities: No Java Help classes found (javax.help.CSH). Client help disabled.", e);
	...
	private static void createLoadingWindow(Window parent) {
		if ((HelpUtilities.loadingWindow == null) || (HelpUtilities.loadingWindow.getOwner() != parent)) {
			...
			((JComponent) HelpUtilities.loadingWindow.getContentPane()).setBorder(new CompoundBorder(new BevelBorder(BevelBorder.RAISED), new EmptyBorder(10, 10, 10, 10)));
	...
	protected static void showDefaultHelp_(Window parent) {
		...
		try {
			Thread.yield();
			URL hsURL = javax.help.HelpSet.findHelpSet(HelpUtilities.class.getClassLoader(), HelpUtilities.default_Ontimize_help_hs, ApplicationManager.getLocale());
			Thread.yield();
			if (hsURL == null) {
				if (parent instanceof Frame) {
					MessageDialog.showMessage((Frame) parent, HelpUtilities.HELP_FILE_ERROR_MESSAGE, JOptionPane.ERROR_MESSAGE, null);
				} else {
					MessageDialog.showMessage((Dialog) parent, HelpUtilities.HELP_FILE_ERROR_MESSAGE, JOptionPane.ERROR_MESSAGE, null);
				}
		...
		new javax.help.CSH.DisplayHelpFromSource((javax.help.HelpBroker) HelpUtilities.hb).actionPerformed(new ActionEvent(source, 1001, null));
				...
				if (target != null) {
					try {
						...
						((javax.help.DefaultHelpBroker) HelpUtilities.hb)
								.setCurrentID(javax.help.Map.ID.create(target, ((javax.help.DefaultHelpBroker) HelpUtilities.hb).getHelpSet()));
					} catch (Exception ee) {
	...
	public synchronized static void showDefaultHelpFromFocus(ActionEvent e) {
		...
		if (HelpUtilities.hb == null) {
			try {
				URL hsURL = javax.help.HelpSet.findHelpSet(HelpUtilities.class.getClassLoader(), HelpUtilities.default_Ontimize_help_hs);
				if (hsURL == null) {
					MessageDialog.showMessage((Frame) null, HelpUtilities.HELP_FILE_ERROR_MESSAGE, JOptionPane.ERROR_MESSAGE, null);
					return;
				}
				HelpUtilities.hs = new javax.help.HelpSet(HelpUtilities.class.getClassLoader(), hsURL);
			} catch (Exception ex) {
	...
	protected static URL getURL(String fileName, Locale l) {
		...
		if (fileName != null) {
			...
			if (pageURL == null) {
				HelpUtilities.logger.debug(HelpUtilities.class.getClass().toString() + " : Not found : " + sCompleteName);
				// Try without the locale
				pageURL = HelpUtilities.class.getClassLoader().getResource(fileName);
				if (pageURL == null) {
					HelpUtilities.logger.debug(HelpUtilities.class.getClass().toString() + " : Not found : " + fileName);
					return null;
				} else {
					return pageURL;
				}
	...
	public static javax.help.HelpSet getDefaultHelpSet() {
		...
		if (HelpUtilities.hs == null) {
			try {
				URL hsURL = javax.help.HelpSet.findHelpSet(HelpUtilities.class.getClassLoader(), "com/ontimize/help/guihelp.hs");
				if (hsURL == null) {
					return null;
				}
				HelpUtilities.hs = new javax.help.HelpSet(HelpUtilities.class.getClassLoader(), hsURL);
	...
	public static void setMainHelpSet(String helpset) {
		...
		if (HelpUtilities.mainHelpSet != null) {
			if (HelpUtilities.hb != null) {
				HelpUtilities.logger.debug("HelpSet is already setted and the help is loaded: MainHelpSet can not be changed");
				return;
			} else {
					...
					if (target != null) {
						try {
							...
							((javax.help.DefaultHelpBroker) HelpUtilities.hbAp)
									.setCurrentID(javax.help.Map.ID.create(target, ((javax.help.DefaultHelpBroker) HelpUtilities.hbAp).getHelpSet()));
						} catch (Exception ee) {
							HelpUtilities.logger.trace(null, ee);
						}
					}
			...
			if ((HelpUtilities.hbAp == null) || (ApplicationManager.getLocale() != HelpUtilities.lastLocale)) {
				try {
					...
					if (HelpUtilities.show_Ontimize_Help) {
						hsURL = javax.help.HelpSet.findHelpSet(HelpUtilities.class.getClassLoader(), HelpUtilities.default_Ontimize_help_hs, ApplicationManager.getLocale());
					}
					URL hsURLAp = javax.help.HelpSet.findHelpSet(HelpUtilities.class.getClassLoader(), HelpUtilities.mainHelpSet);
					Thread.yield();
					if ((hsURL == null) && (hsURLAp == null)) {
						if (parent instanceof Frame) {
							MessageDialog.showMessage((Frame) parent, "M_NO_SE_ENCONTRO_EL_ARCHIVO_DE_AYUDA", JOptionPane.ERROR_MESSAGE, null);
						} else {
							MessageDialog.showMessage((Dialog) parent, "M_NO_SE_ENCONTRO_EL_ARCHIVO_DE_AYUDA", JOptionPane.ERROR_MESSAGE, null);
						}
						HelpUtilities.loadingWindow.setVisible(false);
						return;
					}
				...
				new javax.help.CSH.DisplayHelpFromSource((javax.help.HelpBroker) HelpUtilities.hbAp).actionPerformed(new ActionEvent(source, 1001, null));
			} else {
				Thread.yield();
				Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
		...
		if (HelpUtilities.mainHelpSet == null) {
			...
			try {
					...
					public void run() {
						...
						if (HelpUtilities.hbAp == null) {
							try {
								...
								if ((hsURL == null) && (hsURLAp == null)) {
									if (parent instanceof Frame) {
										MessageDialog.showMessage((Frame) parent, "M_HELP_FILE_NOT_FOUND", JOptionPane.ERROR_MESSAGE, null);
									} else {
										MessageDialog.showMessage((Dialog) parent, "M_HELP_FILE_NOT_FOUND", JOptionPane.ERROR_MESSAGE, null);
									}
									HelpUtilities.loadingWindow.setVisible(false);
									return;
								}
								...
								if ((hsURLAp != null) && (hsURL != null)) {
									HelpUtilities.hsAp = new javax.help.HelpSet(HelpUtilities.class.getClassLoader(), hsURLAp);
									javax.help.HelpSet hs = new javax.help.HelpSet(HelpUtilities.class.getClassLoader(), hsURL);
									((javax.help.HelpSet) HelpUtilities.hsAp).add(hs);
								} else if (hsURLAp != null) {
									HelpUtilities.hsAp = new javax.help.HelpSet(HelpUtilities.class.getClassLoader(), hsURLAp);
								} else if (hsURL != null) {
								...
								HelpUtilities.hbAp = new com.ontimize.help.HelpUtilities.ExtDefaultHelpBroker(HelpUtilities.hsAp);
								HelpUtilities.loadingWindow.setVisible(false);
							} catch (Exception eH) {
				...
				if (HelpUtilities.hbAp != null) {
					...
					new javax.help.CSH.DisplayHelpAfterTracking((javax.help.HelpBroker) HelpUtilities.hbAp).actionPerformed(e);
				}
			} catch (Exception ex) {
				HelpUtilities.logger.trace(null, ex);
			} finally {
