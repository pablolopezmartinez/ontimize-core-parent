...
public class WindowDWarning extends JWindow {
	...
	private class ListenerWD extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			WindowDWarning.this.panel.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED, Color.yellow.brighter(), Color.yellow.darker()));
		}

		@Override
		public void mouseReleased(MouseEvent e) {
			WindowDWarning.this.panel.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED, Color.red.brighter(), Color.red.darker()));
		}
		...
		public void mouseClicked(MouseEvent e) {
			...
			JOptionPane.showMessageDialog(ApplicationManager.getApplication().getFrame(),
					ApplicationManager.getTranslation("WindowDWarning.warningMessage", ApplicationManager.getApplication().getResourceBundle()),
					ApplicationManager.getTranslation("WindowDWarning.warningMessageTitle", ApplicationManager.getApplication().getResourceBundle()), JOptionPane.WARNING_MESSAGE,
	...
	public WindowDWarning(Frame f) {
		...
		this.panel.add(new JLabel(ApplicationManager.getIcon("com/ontimize/ols/resource/images/license_information-48x48.png")));
		this.panel.setBackground(Color.gray.brighter());
		// panel.add(new
		// JLabel("<html><body>Licencia de desarrollo<BR>para uso no comercial</body></html>"));
		this.panel.add(new JLabel(ApplicationManager.getTranslation("WindowDWarning.comercialWarning", ApplicationManager.getApplication().getResourceBundle())));
