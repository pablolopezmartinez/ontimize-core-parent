...
public class WindowLMessage extends JDialog {
	...
	public WindowLMessage(Frame owner) {
		...
		this.jtaMsg.setText(ApplicationManager.getTranslation("ONTIMIZE_LICENSE_TEXT", ApplicationManager.getApplicationBundle()));
		...
		jpContentAll.add(this.jlOnt, new GridBagConstraints(0, 0, 1, 2, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(2, 5, 2, 10), 2, 2));
		jpContentAll.add(this.jtaMsg, new GridBagConstraints(1, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 2, 2), 2, 2));
		// jpContentAll.add(jbDetails,new GridBagConstraints(1,1,1,1,0,0,
		// GridBagConstraints.EAST,GridBagConstraints.NONE,new
		// Insets(2,2,2,2),2,2));
		jpContentAll.add(this.jssp, new GridBagConstraints(0, 2, 2, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 2, 2));
		jpContentAll.add(this.bAcept, new GridBagConstraints(0, 3, 2, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 2, 2));
