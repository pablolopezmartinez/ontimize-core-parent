...
public class LPanel extends JPanel {
	...
	private void init() {
		...
		bt.add(bi, new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.EAST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		/*
		 * bt.add(bs,new GridBagConstraints(1,0,1,1,1,1, GridBagConstraints.WEST, GridBagConstraints.BOTH,new Insets(2,2,2,2),0,0));
		 */

		bt.add(bd, new GridBagConstraints(1, 0, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 0), 0, 0));
		...
		exp.add(new JLabel(ApplicationManager.getTranslation("LPanel.DAYS_TO_EXPIRE", this.bundle)),
				new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
		exp.add(this.daysToExpire, new GridBagConstraints(1, 0, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));

		exp.add(datep, new GridBagConstraints(2, 0, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));

		exp.add(new JLabel(ApplicationManager.getTranslation("LPanel.USER_MAX", this.bundle)),
				new GridBagConstraints(3, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		exp.add(this.userMax, new GridBagConstraints(4, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));

		this.add(bt, new GridBagConstraints(0, 0, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		this.add(new JLabel(ApplicationManager.getTranslation("LPanel.PATH", this.bundle)),
				new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 4, 2, 2), 0, 0));

		this.add(this.path, new GridBagConstraints(1, 1, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(4, 6, 2, 3), 0, 0));

		this.add(new JLabel(ApplicationManager.getTranslation("LPanel.MESSAGE", this.bundle)),
				new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(4, 4, 2, 2), 0, 0));

		this.add(this.message, new GridBagConstraints(1, 2, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 6, 2, 3), 1, 0));

		this.add(new JLabel(ApplicationManager.getTranslation("LPanel.SPECIFIC_DATA", this.bundle)),
				new GridBagConstraints(0, 3, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(4, 4, 2, 2), 0, 0));

		this.add(this.specific, new GridBagConstraints(1, 3, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 6, 2, 3), 1, 0));

		this.add(exp, new GridBagConstraints(0, 4, 2, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
