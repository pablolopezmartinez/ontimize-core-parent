...
/**
 * Interface to listen changes in state of forms (i.e. form changes from QUERY-INSERT to INSERT). This one should be implemented by components that want to perform an operation
 * when state of form changes.
 *
...
public interface InteractionManagerModeListener {
	 ...
	 * <code>e.getInteractionManagerMode()</code>. Value that returns this method can be compared with variables: <br>
	 * <ul>
