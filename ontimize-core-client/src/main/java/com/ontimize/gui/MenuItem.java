...
public class MenuItem extends JMenuItem implements FormComponent, IdentifiedElement, SecureElement, StatusComponent, HasPreferenceComponent, IDynamicItem, IParameterItem, Transferable, DragGestureListener, DragSourceListener {
	 ...
	 *            <td>attr</td>
	 *            <td>no</td>
	 *            <td>The text showed in status bar application. MainApplication translates this text according to the bundle.</td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>icon</td>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>Specifies the file name of button icon. Complete or relative path from Ontimize class location, for example, if an icon is stored in
	 *            com/ontimize/gui/images/item.gif, it would be correct to specify the path like: 'item.gif'. If not stored in any baseImage bundle, write the complete route</td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>shortcut</td>
	 ...
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>The name of FormManager to show. If this parameter isn't established the value is taking from 'attr' parameter</td>
	 *            </tr>
	 *
	 *
	 *            </table>
	...
	static {
		try {
			APPTOOLBARBUTTON_FLAVOR  = new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType + ";class=\"" + ApToolBarButton.class.getName() + "\"");
