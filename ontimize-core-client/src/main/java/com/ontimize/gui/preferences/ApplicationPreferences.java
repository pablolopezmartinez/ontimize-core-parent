...
public interface ApplicationPreferences {
	...
	/**
	 * Get the value of the preference with name <code>preferenceName</code> for the user <code>user</code>
	 *
	 * @param user
	 *            Name of the user or null if the preference is for all users
	...
	/**
	 * Sets the value of the preference with name <code>preferenceName</code> for the user <code>user</code>
	 *
	 * @param user
	 *            Name of the user or null if the preference is for all users
	 * @param preferenceName
