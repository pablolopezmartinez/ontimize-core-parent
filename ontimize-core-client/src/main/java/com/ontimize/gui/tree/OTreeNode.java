...
/**
 * Main class that represents a tree node. It implements <code>Comparable</code> to allow order the nodes. These ones could be organizational or data nodes. Organizational nodes
 * creates the tree structure and data nodes are correspondent with database records. <br>
 * <br>
...
public class OTreeNode extends DefaultMutableTreeNode implements Comparable, Internationalization {
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>Parent key and associated key for node. If parent key name and current-node key are the same name, this field will be filled with pairs of fields with the
	 *            same name.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>iconorg</td>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>Identifier for an organizational node and its children placed in the inmediatly level.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>separator</td>
	 *            <td><i></td>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>For making pageable tree. Number of records that will be downloaded for each page. (since 5.2060EN)</td>
	 *            </tr>
	 *            <tr>
	 *            <td>sort</td>
	 *            <td><i>asc/desc</td>
	 *            <td>asc</td>
	 *            <td>no</td>
	 *            <td>Allow to sort current node ascending/descending. Before this version, ascending sort was set for all nodes(since 5.2077EN-0.3)</td>
	 *            </tr>
	 *            </table>
	 */
	public OTreeNode(Hashtable parameters) {
		...
		try {
			...
			OTreeNode.logger.error(this.getClass().toString() + ": Error in 'queryrows' parameter: " + e.getMessage(), e);
		}
	...
	protected void configureAttrs(Hashtable parameters) {
		...
		if (attr != null) {
			...
			if (this.attrString.length() == 0) {} else {
	...
	protected void configureKeys(Hashtable parameters) {
		...
		if (keys == null) {
			if (ApplicationManager.DEBUG) {
				OTreeNode.logger.debug("INFO: Node entity: " + this.entityName + " : Parameter keys not found. Fatal Error.");
			}
		} else {
	...
	public int compareTo(Object object) {
		if (object instanceof OTreeNode) {
			...
			if ((!(oAttrValue instanceof String)) && (!(oAttrValueObject instanceof String)) && (oAttrValue instanceof Comparable) && (oAttrValueObject instanceof Comparable)) {
				if (this.ascending) {
	...
	/**
	 * Returns a <code>Hashtable</code> where keys are attributes specified in keysValues, and values are their correspondent values.
	 *
	...
	public void setAttribute(String attribute, Object value) {
		if (this.attrString.indexOf(attribute) >= 0) {
			if (value == null) {
				if (ApplicationManager.DEBUG) {
					OTreeNode.logger.debug(this.getClass().toString() + " : NULL Value cann't be established to node attribute");
				}
				return;
			}
	...
	/**
	 * Returns the icon to use with this node. In other case returns null. It is used by class {@link TreeCellRenderer}.
	 *
