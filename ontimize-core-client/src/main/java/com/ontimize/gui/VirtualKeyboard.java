	...
	private JDialog createDialog(Window window, final JTextComponent com) {
		...
		this.copyButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if ((VirtualKeyboard.this.textField.getSelectedText() == null) || (VirtualKeyboard.this.textField.getSelectedText().length() == 0)) {
		...
		panelTextField.add(this.textField, new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		panelTextField.add(this.copyButton, new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
		...
		blockCombo.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				((CharacterTableModel) jTable.getModel()).setLetters((Vector) VirtualKeyboard.blocksCharacters.get(blockCombo.getSelectedItem()));
				jTable.revalidate();
			}
		});
