...
/**
 * The button to refresh a table. Table will be refreshed with parent key values of fields. It is required fields referred to parent keys for table are not empty at refresh moment.
 * <p>
 *
...
public class RefreshTableButton extends Button {
	 ...
	 *
	 * @param parameters
	 *            the hashtable with parameters. Adds the next parameters:
	 * @throws Exception
	...
	public RefreshTableButton(Hashtable parameters) throws Exception {
		...
		super.addActionListener(new com.ontimize.gui.actions.RefreshTableAction(this.entity, this.withoutDataMessage, ajust));
	}
