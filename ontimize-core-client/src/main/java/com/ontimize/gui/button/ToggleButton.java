...
implements com.ontimize.gui.field.FormComponent, AccessForm, Freeable, MouseListener, SecureElement, IdentifiedElement, HasHelpIdComponent {
	...
	public void init(Hashtable parameters) throws Exception {
		...
		Icon pressedIcon = ParseUtils.getPressedImageIcon((String) parameters.get("pressedicon"), (String) parameters.get("icon"), null);
	...
	protected void setDisableIconParameter(Hashtable parameters) {
		Icon disabledIcon = ParseUtils.getDisabledImageIcon((String) parameters.get("disabledicon"), (String) parameters.get("icon"), null);
	...
	protected void setFontColorParameter(Hashtable parameters) {
		...
		if (fontcolor != null) {
			try {
				...
				ToggleButton.logger.error(this.getClass().toString() + " Error 'fontcolor' parameter:" + e.getMessage(), e);
			}
		}
	}
	...
	protected void setMnemonicParameter(Hashtable parameters) {
		...
		if ((mnemonic != null) && !mnemonic.equals("")) {
			try {
				...
				ToggleButton.logger.error(this.getClass().toString() + ". Error: 'mnemonic' parameter: " + e.getMessage(), e);
			}
		}
	}
	...
	protected void setMarginParameter(Hashtable parameters) {
		...
		if (margin != null) {
			try {
				...
				ToggleButton.logger.error(this.getClass().toString() + " : " + this.buttonKey + ": Error: 'margin' parameter " + e.getMessage(), e);
