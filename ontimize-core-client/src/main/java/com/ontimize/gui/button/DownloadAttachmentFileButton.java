...
public class DownloadAttachmentFileButton extends Button {
	 ...
	 *            application until the download finishes. In a not synchronized process more than one file can be downloaded at the same time</td>
	 *            </tr>
	 *            <tr>
	 *            <td>sound</td>
	 *            <td><i>String</td>
	...
	public DownloadAttachmentFileButton(Hashtable parameters) throws Exception {
		...
		super.addActionListener(new com.ontimize.gui.actions.DownloadAttachmentFileAction(this.entity, openFile, sName, bWait, uriSound, askOpen, temporal));
	}
