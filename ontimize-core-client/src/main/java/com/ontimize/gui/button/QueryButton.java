...
/**
 * <p>
 * This button allows to query an entity and fill some form data fields with the query result. The form values in the query moment are used as filter values. <BR>
 * This class uses Button parameters and Table parameters. the 'table_key' parameter is used as key for the table because there is a conflict with the 'key' parameter'.<BR>
 * </p>
 * <p>
 * Company: IMATIA
 * </p>
...
public class QueryButton extends Button implements ReferenceComponent {
	 ...
	 *            <td></td>
	 *            <td>yes</td>
	 *            <td>Data field attributes separated by ';'. This fields will be filled with the query result</td>
	 *            </tr>
	 *            <tr>
	 *            <td>search</td>
	 *            <td><i></td>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>Field attributes (separated by ';'), which are specified in 'search' and are necessary to make the query of data that will be shown in the table.It allows to
	 *            force to intoduce search criterion</td>
	 *            </tr>
	 *            <tr>
	 *            <td>addasterisk</td>
	 *            <td>yes,no</td>
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>Specifies if it automatically includes an * at the end of the string value when it searches for the query attributes</td>
	 *            </tr>
	 *            <tr>
	 *            <td>listen</td>
	 *            <td></td>
	 ...
	 *            <td>no</td>
	 *            <td>Field attributes (subset as 'source') to listen for the button. If some of this fields changes the record select window will be shown</td>
	 *            </tr>
	 *            <tr>
	 *            <td>table_key</td>
	 *            <td></td>
						...
						try {
							...
							for (int i = 0; i < QueryButton.this.formAttributes.size(); i++) {
								if (vTableKeys.contains(QueryButton.this.formAttributes
										.get(i)) && (QueryButton.this.parentForm.getDataFieldValueFromFormCache(QueryButton.this.formAttributes.get(i).toString()) != null)) {
									hKeysValues.put(QueryButton.this.formAttributes.get(i),
											QueryButton.this.parentForm.getDataFieldValueFromFormCache(QueryButton.this.formAttributes.get(i).toString()));
								}
							}
