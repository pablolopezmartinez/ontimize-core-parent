...
public class DownloadTableAttachmentFileButton extends TableButton {
	 ...
	 *            <td>Table entity</td>
	 *            <td>yes</td>
	 *            <td>Parameter to indicate the entity which stores the attachment. By default, this is the table entity</td>
	 *            </tr>
	 *            <tr>
	 *            <td>opendownload</td>
	 *            <td><i>yes,no</td>
	 ...
	 *            <td>yes</td>
	 *            <td>no</td>
	 *            <td>Parameter to indicate if the process is synchronized or not. If it is a synchronized process a progress window appears during the process and blocks the
	 *            application until the download finishes.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>sound</td>
	 *            <td>String</td>
	 ...
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>If open=yes and wait=yes and tempfile=yes a temporal file will be created. In this way user has not to select the file name and location</td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <td>null</td>
	 *            <td>no</td>
	 *            <td>Column which stores the original name of the file, to set the name of the original file as the name of the download file by default</td>
	 *            </tr>
	 *            </table>
	 *            <br>
	 *            </tr>
	...
	public DownloadTableAttachmentFileButton(Hashtable parameters, Table table) throws Exception {
		...
		super.addActionListener(new DownloadTableAttachmentFileAction(this.entity, openFile, sName, bWait, uriSound, askOpen, temporal, table));
	}
}
