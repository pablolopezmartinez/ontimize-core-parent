    ...
    public PopupPrintingTemplateList(Form f, boolean bPrivateTemplates) {
        ...
        this.helpItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String labeltext = new String(ApplicationManager.getTranslation(Form.messageNameFieldTemplate,
        ...
        this.addTemplateItem.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                EntityReferenceLocator locator = PopupPrintingTemplateList.this.form.getFormManager()
                    .getReferenceLocator();
                try {
                    Entity templateEntity = ((UtilReferenceLocator) locator)
            ...
            if (hRecord.containsKey(Form.TEMPLATE_PRIVATE)) {
                ...
                if (o instanceof Number) {
                    ...
                    if (bPrivate) {
                        ...
                        int value = this.form.message(PopupPrintingTemplateList.M_CHANGE_USER_TEMPLATE,
                    ...
                    try {
                        ...
                        if ((res.getCode() != EntityResult.OPERATION_WRONG) && (res.calculateRecordNumber() == 1)) {
                            if (res.containsKey(Form.TEMPLATE_NAME) && res.containsKey(Form.TEMPLATE_WAREHOUSE)) {
                                ...
                                DataFile file = new DataFile(templateName,
                                        (BytesBlock) ((Vector) res.get(Form.TEMPLATE_WAREHOUSE)).firstElement());
            ...
            OperationThread t = new OperationThread() {
                ...
                public void run() {
                    try {
                        ...
                        EntityResult res = PopupPrintingTemplateList.this.form
                        ...
                        boolean oldValueChangeListener = PopupPrintingTemplateList.this.form.getInteractionManager()
