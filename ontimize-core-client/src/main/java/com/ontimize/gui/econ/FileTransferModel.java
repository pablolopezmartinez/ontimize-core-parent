...
public class FileTransferModel {
	...
	protected abstract class FileTransferRegister {
		...
		public FileTransferRegister(String applicantCode) {
			if (applicantCode.length() > 10) {
				...
				throw new IllegalArgumentException("Transferor code  invalid (maximum 10 characters): " + applicantCode);
			}
	...
	protected abstract class BeneficiaryRegister extends FileTransferRegister {
		...
		public BeneficiaryRegister(String applicantCode, String beneficiaryCode) throws IllegalArgumentException {
			...
			if (beneficiaryCode.length() > 12) {
				FileTransferModel.logger.debug("Beneficiary code is invalid (maximum 12 character): " + beneficiaryCode);
				throw new IllegalArgumentException("Beneficiary code is invalid (maximum 12 character): " + beneficiaryCode);
			}
			// Fills values
			for (int i = 0; i < this.zoneAValue.length; i++) {
				this.zoneA[i] = this.zoneAValue[i];
	...
	protected class TotalRegisters extends FileTransferRegister {
		...
		public TotalRegisters(String applicantCode, double amountSum, int numberOfRegistry010, int totalRegistryBenificiaryHeaderNumber) throws IllegalArgumentException {
			super(applicantCode);
	...
	protected class HeadRegister1 extends HeadRegister {
		...
		public HeadRegister1(String applicantCode, Date sendDate, Date creationDate, String entityNumber, String officeNumber, String accountNumber, char chargeDetail,
			...
			if ((chargeDetail != HeadRegister1.F6_WITH_RELATION) && (chargeDetail != HeadRegister1.F6_WITHOUT_RELATION)) {
				FileTransferModel.logger.debug("Invoice detail character must be " + HeadRegister1.F6_WITH_RELATION + " ó " + HeadRegister1.F6_WITHOUT_RELATION);
				throw new IllegalArgumentException("Invoice detail character must be " + HeadRegister1.F6_WITH_RELATION + " ó " + HeadRegister1.F6_WITHOUT_RELATION);
			}
			// Now formats
	...
	protected class BeneficiaryRegister1 extends BeneficiaryRegister {
		...
		public BeneficiaryRegister1(String applicantCode, String beneficiaryCode, double amount, String entityNumber, String branchNumber, String accountNumber, char expenditure,
			...
			if ((expenditure != BeneficiaryRegister1.F5_BY_ORDERER_ACCOUNT) && (expenditure != BeneficiaryRegister1.F5_BY_BENEFICIARY_ACCOUNT)) {
			...
			if ((concept != BeneficiaryRegister1.F6_SALARY_CONCEPT) && (concept != BeneficiaryRegister1.F6_PENSION_CONCEPT) && (concept != BeneficiaryRegister1.F6_OTHER_CONCEPTS)) {
	...
	protected abstract class BeneficiaryRegister2to8 extends BeneficiaryRegister {
		...
		public BeneficiaryRegister2to8(String applicantCode, String beneficiaryCode, String content) throws IllegalArgumentException {
			super(applicantCode, beneficiaryCode);
	...
	protected class BeneficiaryRegister2 extends BeneficiaryRegister2to8 {
		...
		public BeneficiaryRegister2(String applicantCode, String beneficiaryCode, String beneficiaryName) throws IllegalArgumentException {
	...
	protected class BeneficiaryRegister3 extends BeneficiaryRegister2to8 {
		...
		public BeneficiaryRegister3(String applicantCode, String beneficiaryCode, String beneficiaryAddress) throws IllegalArgumentException {
	...
	protected class BeneficiaryRegister4 extends BeneficiaryRegister2to8 {
		...
		public BeneficiaryRegister4(String applicantCode, String beneficiaryCode, String beneficiaryAddress) throws IllegalArgumentException {
			super(applicantCode, beneficiaryCode, beneficiaryAddress);
			for (int i = 0; i < this.zoneEValue.length; i++) {
				this.zoneE[i] = this.zoneEValue[i];
			}
	...
	protected class BeneficiaryRegister5 extends BeneficiaryRegister2to8 {
		...
		public BeneficiaryRegister5(String applicantCode, String beneficiaryCode, String postalCode) throws IllegalArgumentException {
	...
	protected class BeneficiaryRegister6 extends BeneficiaryRegister2to8 {
		...
		public BeneficiaryRegister6(String applicantCode, String beneficiaryCode, String beneficiaryProvince) throws IllegalArgumentException {
	...
	protected class BeneficiaryRegister7 extends BeneficiaryRegister2to8 {
		...
		public BeneficiaryRegister7(String applicantCode, String beneficiaryCode, String concept) throws IllegalArgumentException {
	...
	protected class BeneficiaryRegister9 extends BeneficiaryRegister {
		...
		public BeneficiaryRegister9(String applicantCode, String beneficiaryCode, String dni) throws IllegalArgumentException {
			super(applicantCode, beneficiaryCode);
			for (int i = 0; i < this.zoneEValue.length; i++) {
				this.zoneE[i] = this.zoneEValue[i];
			}
	...
	public FileTransferModel(String applicantCode, Date sendDate, Date emissionDate, String applicantEntity, String applicantOffice, String applicantAccount, char debitDetail,
			String applicantName, String applicantAddress, String applicantPost, String controlDigit, String accountOfName, String accountAddress,
	...
	public Vector generate() {
		...
		HeadRegister1 headerRegistry1 = new HeadRegister1(this.ordererCode, this.sendDate, this.emissionDate, this.ordererBank, this.ordererBranch, this.ordererAccount,
		...
		for (int i = 0; i < this.beneficiaryData.getSize(); i++) {
			...
			BeneficiaryRegister1 registroB1 = new BeneficiaryRegister1(this.ordererCode, bdtDataB.getBeneficiaryCode(), bdtDataB.getAmount(), bdtDataB.getBankNumber(),
					bdtDataB.getBranch(), bdtDataB.getCurrentAccount(), bdtDataB.getCosts(), bdtDataB.getConcept(), bdtDataB.getControlDigit());
			BeneficiaryRegister2 registroB2 = new BeneficiaryRegister2(this.ordererCode, bdtDataB.getBeneficiaryCode(), bdtDataB.getBeneficiaryName());

			BeneficiaryRegister3 registroB3 = new BeneficiaryRegister3(this.ordererCode, bdtDataB.getBeneficiaryCode(), bdtDataB.getBeneficiaryAddress());

			BeneficiaryRegister5 registroB5 = new BeneficiaryRegister5(this.ordererCode, bdtDataB.getBeneficiaryCode(), bdtDataB.getBeneficiaryZipCode());

			BeneficiaryRegister6 registroB6 = new BeneficiaryRegister6(this.ordererCode, bdtDataB.getBeneficiaryCode(), bdtDataB.getBeneficiaryProvince());

			BeneficiaryRegister7 registroB7 = new BeneficiaryRegister7(this.ordererCode, bdtDataB.getBeneficiaryCode(), bdtDataB.getTransferConcept());
			...
			if ((dni != null) && (!dni.equals(""))) {
				BeneficiaryRegister9 registroB9 = new BeneficiaryRegister9(this.ordererCode, bdtDataB.getBeneficiaryCode(), bdtDataB.getDNI());
