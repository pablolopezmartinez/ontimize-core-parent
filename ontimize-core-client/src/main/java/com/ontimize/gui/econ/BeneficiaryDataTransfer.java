...
public class BeneficiaryDataTransfer {
    ...
    public BeneficiaryDataTransfer(String benfCode, double amount, String bankNumber, String branchNumber,
            String accountNumber, char costs, char concept, String controlDigit,
            String beneficiaryName, String benefAddress, String zipCode, String province, String transferConcept,
            String dni) {
    ...
    public String toString() {
        return this.getBeneficiaryCode() + "," + this.getConcept() + "," + this.getTransferConcept() + ","
                + this.getBeneficiaryZipCode() + "," + this
                    .getControlDigit()
                + "," + this.getDNI() + "," + this.getBeneficiaryAddress() + "," + this.getCosts() + ","
                + this.getAmount() + "," + this
                    .getBeneficiaryName()
                + "," + this.getCurrentAccount() + "," + this.getBankNumber() + "," + this.getBranch() + ","
                + this.getBeneficiaryProvince();
    }
