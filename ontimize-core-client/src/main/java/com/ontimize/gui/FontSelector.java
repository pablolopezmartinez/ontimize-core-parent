...
public class FontSelector implements Freeable {
	...
	static String[]						uIKeys			= { FontSelector.checkBox, FontSelector.tree, FontSelector.toggleButton, FontSelector.menuItemRadio, FontSelector.menuItem, FontSelector.menu, FontSelector.panel, FontSelector.textArea, FontSelector.tableHeader, FontSelector.textField, FontSelector.optionPane, FontSelector.menuBar, FontSelector.button, FontSelector.label, FontSelector.list, FontSelector.table, FontSelector.panelTabs, FontSelector.radioButton, FontSelector.menuItemCheck, FontSelector.menuPopup, FontSelector.border, FontSelector.comboBox, FontSelector.spinner };
	...
	protected static class SimpleFontsDialog extends EJDialog implements Internationalization {
		...
		public SimpleFontsDialog(Frame f, String title) {
			...
			this.fontCombo.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent e) {
					if (e.getStateChange() == ItemEvent.SELECTED) {
						...
						SimpleFontsDialog.this.currentFont = new FontUIResource(new Font(sel.toString(), Font.PLAIN, SimpleFontsDialog.this.exampleJText.getFont().getSize()));
			...
			this.sizeCombo.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent e) {
					if (e.getStateChange() == ItemEvent.SELECTED) {
						...
						SimpleFontsDialog.this.currentFont = new FontUIResource(SimpleFontsDialog.this.exampleJText.getFont().deriveFont((float) size));
						SimpleFontsDialog.this.exampleJText.setFont(SimpleFontsDialog.this.currentFont);
					}
				}
			});
			...
			this.contentPanel.add(panelNorte, new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 2, 2, 2), 0, 0));
			this.contentPanel.add(buttonsPanel, new GridBagConstraints(1, 0, 1, 2, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(5, 2, 2, 2), 0, 0));
			this.contentPanel.add(new JScrollPane(this.exampleJText),
					new GridBagConstraints(0, 1, 1, 1, 1, 1, GridBagConstraints.NORTH, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		...
		public void setResourceBundle(ResourceBundle res) {
			...
			this.contentPanel.setBorder(new TitledBorder(ApplicationManager.getTranslation(SimpleFontsDialog.sourceKey, res)));
	...
	class FontDialog extends JDialog {
		...
		public FontDialog(Frame parentFrame, boolean supportingEuro) {
			...
			radioButtonsPanel.add(this.treeButton, new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			radioButtonsPanel.add(this.menuButton, new GridBagConstraints(1, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			radioButtonsPanel.add(this.tableButton, new GridBagConstraints(2, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			radioButtonsPanel.add(this.textFieldButton, new GridBagConstraints(3, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			radioButtonsPanel.add(this.bButtons, new GridBagConstraints(4, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			radioButtonsPanel.add(this.allButtons, new GridBagConstraints(5, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			radioButtonsPanel.add(this.fontSize);
			this.fontSize.setSelectedIndex(4);
			radioButtonsPanel.add(this.text, new GridBagConstraints(0, 1, 6, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
			buttonsPanel.add(this.apply, new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			buttonsPanel.add(this.close, new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			buttonsPanel.add(this.reset, new GridBagConstraints(2, 1, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					...
					if (FontDialog.this.treeButton.isSelected()) {
						...
						if (o instanceof Font) {
							...
							for (int i = 0; i < model.getSize(); i++) {
								...
								if ((oFontName != null) && oFontName.toString().equalsIgnoreCase(((Font) o).getFamily())) {
					...
					if (FontDialog.this.tableButton.isSelected()) {
						...
						if (o instanceof Font) {
							...
							for (int i = 0; i < model.getSize(); i++) {
								...
								if ((fontName != null) && fontName.toString().equalsIgnoreCase(((Font) o).getFamily())) {
									FontDialog.this.list.setSelectedIndex(i);
									FontDialog.this.list.ensureIndexIsVisible(i);
									break;
								}
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (oSelectedValue == null) {
						...
						try {
							...
							FontDialog.this.font = new FontUIResource(new Font(oSelectedValue.toString(), Font.PLAIN, size));
							if (FontDialog.this.treeButton.isSelected()) {
