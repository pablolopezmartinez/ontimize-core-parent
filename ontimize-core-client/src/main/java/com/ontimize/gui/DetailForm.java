 ...
 */
public class DetailForm extends EJDialog implements Internationalization, DataNavigationListener, IDetailForm,Freeable {
	...
	public DetailForm(Frame f, String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Table sourceTable, Hashtable parentkeys) {
		this(f, title, modal, form, tableKeys, keyFields, sourceTable, parentkeys, null);
	}

	public DetailForm(Frame f, String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Table sourceTable, Hashtable parentkeys, Hashtable codValues) {
		super(f, title, modal);
		this.initCodValues(codValues);
		this.init(title, form, tableKeys, keyFields, sourceTable, parentkeys);
	}

	public DetailForm(Dialog d, String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Table sourceTable, Hashtable parentkeys) {
		this(d, title, modal, form, tableKeys, keyFields, sourceTable, parentkeys, null);
	}

	public DetailForm(Dialog d, String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Table sourceTable, Hashtable parentkeys, Hashtable codValues) {
		super(d, title, modal);
		this.initCodValues(codValues);
		this.init(title, form, tableKeys, keyFields, sourceTable, parentkeys);
	}

	public DetailForm(String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Table sourceTable, Hashtable parentKeys) {
		this(title, modal, form, tableKeys, keyFields, sourceTable, parentKeys, null);
	}

	public DetailForm(String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Table sourceTable, Hashtable parentkeys, Hashtable codValues) {
	 ...
	 */
	@Deprecated
	public DetailForm(Frame f, String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Object parentkeyValue, String parentkeyName, Table sourceTable,
	 ...
	 */
	@Deprecated
	public DetailForm(Dialog d, String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Object parentkeyValue, String parentkeyName, Table sourceTable,
			Hashtable otherParentkeys) {
	 ...
	 */
	@Deprecated
	public DetailForm(String title, boolean modal, Form form, Hashtable tableKeys, Vector keyFields, Object parentkeyValue, String parentkeyName, Table sourceTable,
			Hashtable otherParentKeys) {
	 ...
	 */
	@Deprecated
	protected void init(String title, Form form, Hashtable tableKeys, Vector keyFields, Object parentkeyValue, String parentkeyName, Table sourceTable, Hashtable otherParentkeys) {
	...
	protected void init(String title, Form form, Hashtable tableKeys, Vector keyFields, Table sourceTable, Hashtable parentkeyValues) {
	...
	protected EntityResult query(int index) {
		...
		try {
			...
			DetailForm.logger.error("DetailForm: Error in query. Check the parameters, the xml and the entity configuration", e);
			if (ApplicationManager.DEBUG) {
	...
	protected void installButtonsListeners() {
		...
		if ((this.form.previousButton == null) || (this.form.endButton == null) || (this.form.startButton == null) || (this.form.nextButton == null)) {
			...
			try {
				...
				DetailForm.logger.debug(this.getClass().toString() + ": " + "Detail form. Icons error. " + e.getMessage(), e);
		...
		if (e.getID() == WindowEvent.WINDOW_CLOSING) {
			if (this.getForm().getInteractionManager() != null) {
				if (this.getCheckDataBeforeClose()) {
					if ((!this.getForm().getInteractionManager().getModifiedFieldAttributes().isEmpty()) && this.getForm().getInteractionManager()
		...
		if (dynamicFormManager != null) {
			...
			if (!this.cacheForms.containsKey(formToShow)) {
				...
				if (formManager.getInteractionManager(formToShow) == null) {
					formManager.setInteractionManager(dynamicFormManager.getFormInteractionManagerClass(formToShow), formToShow);
				}
				...
				if (ApplicationManager.DEBUG) {
					DetailForm.logger.debug("Registered DetailForm as DataChanged listener to manage the dynamic form: " + formToShow);
				}
			}
	...
	public void dataChanged(DataNavigationEvent e) {
		...
		if (dynamicFormManager != null) {
			...
			if (!this.cacheForms.containsKey(formToShow)) {
				...
				this.installButtonsListeners();
				if (ApplicationManager.DEBUG) {
					DetailForm.logger.debug("Registering DeatailForm as DataChanged listener to manage dynamic form: " + formToShow);
				}
			}
			this.showForm(formToShow);
			if (ApplicationManager.DEBUG) {
