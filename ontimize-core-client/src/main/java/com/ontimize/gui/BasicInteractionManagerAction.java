...
public class BasicInteractionManagerAction implements InteractionManagerAction {
    ...
    public static class BasicModeAction implements ModeAction {
        ...
        public BasicModeAction(String name, String attr, String className, String value)
         ...
         * @param clazz Class name for the parameter value.
        ...
        public boolean equals(Object o) {
            if (o instanceof ModeAction) {
                ...
                return (thisName != null) && (otherName != null) && thisName.equalsIgnoreCase(otherName)
                        && (thisAttr != null) && (otherAttr != null) && thisAttr
                ...
                try {
                    ...
                    if (reference == null) {
                        throw new IllegalArgumentException(
                                BasicListener.MSG_ELEMENT_NULL_1 + attr + BasicListener.MSG_ELEMENT_NULL_2 + formName);
                    }
                    ...
                    if (method == null) {
                        throw new IllegalArgumentException(
                                BasicListener.MSG_METHOD_NULL_1 + typeWithAdd + BasicListener.MSG_METHOD_NULL_2 + attr
                                        + BasicListener.MSG_METHOD_NULL_3 + formName);
                    }

                    method.invoke(reference, new Object[] { instance });
                } catch (InvocationTargetException e) {
                    BasicInteractionManagerAction.error(
                            new Object[] { BasicListener.MSG_METHOD_INVALID_1, typeWithAdd,
                                    BasicListener.MSG_METHOD_INVALID_2, clazz, BasicListener.MSG_METHOD_INVALID_3, attr,
                                    BasicListener.MSG_METHOD_INVALID_4, formName, e });
                } catch (Exception ex) {
    ...
    public static class BasicListenerItem implements ListenerItem {
        ...
        public BasicListenerItem(Object id, String attr, String className, String type)
                throws IllegalArgumentException {
            if (id == null) {
    ...
    public void setMode(Form form, String modeId) {
        ...
        for (int i = 0, size = actions != null ? actions.size() : 0; i < size; i++) {
            ...
            try {
                ...
                Object reference = form.getElementReference(attr);
                if (reference == null) {
                    throw new IllegalArgumentException(BasicInteractionManagerAction.MSG_ELEMENT_NULL_1 + attr
                            + BasicInteractionManagerAction.MSG_ELEMENT_NULL_2 + formName);
                }
                ...
                if (method == null) {
                    throw new IllegalArgumentException(
                            BasicInteractionManagerAction.MSG_METHOD_NULL_1 + nameWithSet
                                    + BasicInteractionManagerAction.MSG_METHOD_NULL_2 + attr
                                    + BasicInteractionManagerAction.MSG_METHOD_NULL_3 + formName);
                }
                method.invoke(reference, new Object[] { value });
            } catch (InvocationTargetException e) {
                BasicInteractionManagerAction.error(
                        new Object[] { BasicInteractionManagerAction.MSG_METHOD_INVALID_1, nameWithSet,
                                BasicInteractionManagerAction.MSG_METHOD_INVALID_2, value,
                                BasicInteractionManagerAction.MSG_METHOD_INVALID_3, attr,
                                BasicInteractionManagerAction.MSG_METHOD_INVALID_4, formName, e });
            } catch (Exception ex) {
                BasicInteractionManagerAction.error(ex);
            }
        }
