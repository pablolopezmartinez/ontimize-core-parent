...
public class CustomColumnGridBagLayout extends GridBagLayout {
	...
	public CustomColumnGridBagLayout(Container container) {
		super();
		this.cont = container;
		this.defaultConstraints = new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1, 0, GridBagConstraints.NORTH, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0,
				0);
	}
	...
	public void removeLayoutComponent(Component comp) {
		...
		if (componentCount > 1) {
			if (this.vAlignment == GridBagConstraints.CENTER) {} else if (this.vAlignment == GridBagConstraints.SOUTH) {
				GridBagConstraints auxConstraints = null;
