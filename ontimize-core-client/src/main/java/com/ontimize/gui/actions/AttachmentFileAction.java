...
public class AttachmentFileAction extends AbstractButtonAction {
	...
	public AttachmentFileAction(String entity, boolean addDescription, boolean refreshForm, boolean wait, String uriSound) {
		...
		try {
			...
			if (this.synchronize) {
				...
				for (int i = 0; i < files.length; i++) {
					ExtendedOperationThread eop = this.createSendThread(f, files[i], (String) oDescription, this.uriSound);
