...
public class DownloadTableAttachmentFileAction extends DownloadAttachmentFileAction {
	...
	public DownloadTableAttachmentFileAction(String entity, boolean openFile, String sName, boolean bWait, String uriSound, boolean askOpen, boolean temporal, Table table) {
