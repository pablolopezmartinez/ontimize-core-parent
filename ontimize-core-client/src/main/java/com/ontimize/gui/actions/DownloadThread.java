...
public class DownloadThread extends ExtendedOperationThread {
	...
	public DownloadThread(ResourceBundle res, File selFile, Hashtable kv, FileManagementEntity entF, EntityReferenceLocator locator) {
	...
	public DownloadThread(ResourceBundle res, File seltFile, Hashtable kv, FileManagementEntity entF, EntityReferenceLocator locator, int blockSize, String uriSound) {
