...
public class HTMLComponent extends JTextPane implements FormComponent, IdentifiedElement, AccessForm, Freeable {
	...
	/**
	 * This class implements an extension html editor where the document creation priority is set to minimum.
	 * <p>
	 *
	 * @author Imatia Innovation
	 */
	...
	/**
	 * The class constructor. Inits parameters, sets transparent and disables the edition in the component.
	 * <p>
	 *
	 * @param parameters
	 ...
	 *            <td></td>
	 *            <td>yes</td>
	 *            <td>Associated file. The extension file must be <code>.htm</code> or <code>.html</code>.</td>
	 *            </tr>
	 *
	 *            </TABLE>
	 *
