...
/**
 * This class create a checkbox field where methods <code>getValue</code> and <code>setValue</code> use <code>Integer</code> with '1' for selected value and '0' for deselected
 * value.
 * <p>
 *
...
public class CheckDataField extends DataField implements AdvancedDataComponent, ITemplateField {
	...
	protected class InnerListener implements ItemListener {
		...
		public void itemStateChanged(ItemEvent e) {
			if (this.isInnerListenerEnabled) {
				...
				CheckDataField.this.fireValueChanged(CheckDataField.this.getValue(), this.innerValue, ValueEvent.USER_CHANGE);
			}
		}
	 ...
	 */
	protected Border borderNotIncluded = new CompoundBorder(new LineBorder(Color.red, 2), new BevelBorder(BevelBorder.LOWERED));
	 ...
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>Indicates whether <CODE>getValue()</CODE> returns a <CODE>boolean</CODE>. By default, returns an <code>Integer</code>.</td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>returnstring</td>
	 ...
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>Indicates whether returns the value in <code>String</code> format.(S->True, N->False)</td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>selecticon</td>
	...
	public void init(Hashtable parameters) {
		...
		this.selectIcon = ParseUtils.getImageIcon((String) parameters.get(CheckDataField.SELECT_ICON), CheckDataField.defaultSelectIcon);
		this.deselectIcon = ParseUtils.getImageIcon((String) parameters.get(CheckDataField.DESELECT_ICON), CheckDataField.defaultDeselectIcon);
	 ...
	 *
	 * @return <code>true</code> if the field is in query mode and the field is included in the search,<code>false</code> otherwise.
	 */
	...
	public Object getTemplateDataValue() {
		if (this.getValue() instanceof Boolean) {
			return ApplicationManager.getTranslation(this.getValue().toString(), ApplicationManager.getApplicationBundle());
		} else {
