...
public abstract class AbstractFormComponent extends JComponent implements FormComponent, Freeable {
	...
	public Object getConstraints(LayoutManager parentLayout) {
		if (parentLayout instanceof GridBagLayout) {
			return new GridBagConstraints(GridBagConstraints.RELATIVE, 0, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
					new Insets(AbstractFormComponent.defaultTopMargin, AbstractFormComponent.defaultLeftMargin, AbstractFormComponent.defaultBottomMargin,
