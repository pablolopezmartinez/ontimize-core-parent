...
public class BGColorPanel extends JPanel implements Internationalization {
	...
	protected JPanel getColorPanel() {
		if (this.colorPanel == null) {
			...
			this.colorPanel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
		...
		if (this.colorButton == null) {
			...
			this.colorButton.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					Color c = JColorChooser.showDialog(BGColorPanel.this, BGColorPanel.i18n.str("HTMLShef.color"), BGColorPanel.this.selColor);
					if (c != null) {
