...
/**
 * Interface to implement by all chart components independent of version of JFreeChart that it is being used. At this moment, <code>Ontimize</code> provides two different
 * implementations for component Chart:
 * <ul>
