...
public class HTMLInlineAction extends HTMLTextEditAction {
	...
	private static final String[] INLINE_TYPES = { "HTMLShef.emphasis", "HTMLShef.strong", "HTMLShef.code", "HTMLShef.cite", "HTMLShef.superscript", "HTMLShef.subscript",
	...
	private static final int[]		MNEMS				= { HTMLTextEditAction.i18n.mnem("HTMLShef.emphasis"), HTMLTextEditAction.i18n
			.mnem("HTMLShef.strong"), HTMLTextEditAction.i18n.mnem("HTMLShef.code"), HTMLTextEditAction.i18n.mnem("HTMLShef.cite"), HTMLTextEditAction.i18n
			.mnem("HTMLShef.superscript"), HTMLTextEditAction.i18n.mnem("HTMLShef.subscript"), HTMLTextEditAction.i18n.mnem("HTMLShef.bold"), HTMLTextEditAction.i18n
			.mnem("HTMLShef.italic"), HTMLTextEditAction.i18n.mnem("HTMLShef.underline"), HTMLTextEditAction.i18n.mnem("HTMLShef.strikethrough") };
