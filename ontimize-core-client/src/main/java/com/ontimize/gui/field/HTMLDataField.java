...
public class HTMLDataField extends MemoDataField implements AdvancedDataComponent, ITemplateField {
	...
	protected class ActionWrapper implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			HTMLDataField.this.fireValueChanged(HTMLDataField.this.getValue(), HTMLDataField.this.valueSave, ValueEvent.USER_CHANGE);
		}
	}
		...
		this.dataField.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if ((e.getKeyCode() == KeyEvent.VK_SPACE) && e.isControlDown() && e.isAltDown()) {
					MessageDialog.showMessage(HTMLDataField.this.parentFrame, (String) HTMLDataField.this.getValue(), JOptionPane.INFORMATION_MESSAGE, null);
				}
			}
		});
	...
	protected void installButtonsHandler() {
		...
		((JTextComponent) this.dataField).addCaretListener(new CaretListener() {
			...
			public void caretUpdate(CaretEvent e) {
				...
				Element element = ((StyledDocument) ((JTextComponent) HTMLDataField.this.dataField).getDocument()).getCharacterElement(dot);
				if (element != null) {
				...
				Element pElement = ((StyledDocument) ((JTextComponent) HTMLDataField.this.dataField).getDocument()).getParagraphElement(dot);
				if (pElement != null) {
			...
			protected void processKeyEvent(KeyEvent e) {
				if ((e.getKeyCode() == KeyEvent.VK_F3) && (e.getID() == KeyEvent.KEY_RELEASED)) {
					if (HTMLDataField.this.dQuery == null) {
						HTMLDataField.this.dQuery = new FindDialog(HTMLDataField.this.parentFrame, (JTextComponent) HTMLDataField.this.dataField);
						...
						HTMLDataField.this.dQuery.show(((JTextComponent) HTMLDataField.this.dataField).getCaretPosition());
					} else {
						if (HTMLDataField.this.dQuery != null) {
							HTMLDataField.this.dQuery.find(((JTextComponent) HTMLDataField.this.dataField).getCaretPosition());
						}
					}
					e.consume();
					return;
