...
public class CalendarSpinnerDataField extends DataField {
	...
	protected static class CalendarSpinnerGroup extends JPanel implements Internationalization {
		...
		public CalendarSpinnerGroup(Hashtable parameters) {
			...
			CalendarSpinnerDataFieldDateEditor spDaysEditor = new CalendarSpinnerDataFieldDateEditor(this.spinnerDays, "d");
			this.spinnerDays.setEditor(spDaysEditor);
			CalendarSpinnerDataFieldDateEditor spMonthsEditor = new CalendarSpinnerDataFieldDateEditor(this.spinnerMonths, "MMMMM");
			this.spinnerMonths.setEditor(spMonthsEditor);
			CalendarSpinnerDataFieldDateEditor spYearsEditor = new CalendarSpinnerDataFieldDateEditor(this.spinnerYears, "yyyy");
			this.spinnerYears.setEditor(spYearsEditor);

			((CalendarSpinnerDataFieldDateEditor) this.spinnerDays.getEditor()).getTextField().setDocument(new SpinnerDateDocument("d"));
			((CalendarSpinnerDataFieldDateEditor) this.spinnerMonths.getEditor()).getTextField().setDocument(new SpinnerDateDocument("MMMMM"));
			((CalendarSpinnerDataFieldDateEditor) this.spinnerYears.getEditor()).getTextField().setDocument(new SpinnerDateDocument("yyyy"));
		...
		public void setDefaultLayout() {
			if (this.layoutType.equals(CalendarSpinnerGroup.HORIZONTAL_LAYOUT)) {
				this.add(this.spinnerDays, new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
				this.add(this.spinnerMonths, new GridBagConstraints(1, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
				this.add(this.spinnerYears, new GridBagConstraints(2, 0, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
			} else if (this.layoutType.equals(CalendarSpinnerGroup.VERTICAL_LAYOUT)) {
				this.add(this.spinnerDays, new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
				this.add(this.spinnerMonths, new GridBagConstraints(0, 1, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
				this.add(this.spinnerYears, new GridBagConstraints(0, 2, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
			}
		}
	...
	protected class InnerListener implements ChangeListener {
		...
		public void stateChanged(ChangeEvent e) {
			if (this.innerListenerEnabled) {
				CalendarSpinnerDataField.this.fireValueChanged(CalendarSpinnerDataField.this.getValue(), this.storeInnerValue, ValueEvent.USER_CHANGE);
	...
	public void installButtons() {
		...
		if (this.calendarbutton) {
			...
			super.add(this.calendarButton, new GridBagConstraints(GridBagConstraints.RELATIVE, GridBagConstraints.RELATIVE, 1, 1, 0, 0, GridBagConstraints.CENTER,
		...
		if (this.deletebutton) {
			...
			super.add(this.deleteButton, new GridBagConstraints(GridBagConstraints.RELATIVE, GridBagConstraints.RELATIVE, 1, 1, 0, 0, GridBagConstraints.CENTER,
					GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		}
	...
	public void showCalendar(Component c) {
		...
		if (!this.calendarChange) {
			...
			if ((day != previousDay) || (month != previousMonth) || (year != previousYear) || (bPreviousValueNull && (oNewValue != null))) {
				this.fireValueChanged(oNewValue, oValue, ValueEvent.USER_CHANGE);
			}
		}
	}
		...
		if (this.calendarComp == null) {
			...
			this.calendarComp.addCalendarListener(new CalendarListener() {
				...
				public void dateChanged(CalendarEvent e) {
					CalendarSpinnerDataField.this.setValueFromComponent(CalendarSpinnerDataField.this.calendarComp.getCurrentDate());
				}
			});
	...
	protected void registerKey() {
		...
		AbstractAction act = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				CalendarSpinnerDataField.logger.debug(((DefaultEditor) group.getSpinnerDays().getEditor()).getTextField().getValue().toString());
				CalendarSpinnerDataField.logger.debug(((DefaultEditor) group.getSpinnerMonths().getEditor()).getTextField().getValue().toString());
				CalendarSpinnerDataField.logger.debug(((DefaultEditor) group.getSpinnerYears().getEditor()).getTextField().getValue().toString());
			}
