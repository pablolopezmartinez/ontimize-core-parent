...
public class IntegerDocument extends PlainDocument {
	...
	/**
	 * This method returns a <code>Number</code> object in function of <code>type</code> specified in {@link #getNumberTypeUsed()} (This type is also modifiable in parameter
	 * <code>"numbertype"</code> of {@link IntegerDataField#init(java.util.Hashtable)}. Available types are:
	 *
	 * <ul>
	 * <li>BIGINTEGER
	 * <li>BIGDECIMAL
	...
	public void insertString(int offset, String stringValue, AttributeSet attributes) throws BadLocationException {
		...
		try {
			...
			if (this.numberFormat.getMaximumIntegerDigits() > 0) {
				if ((this.getText(0, this.getLength()).indexOf(".") == -1) && (this.getLength() >= this.numberFormat.getMaximumIntegerDigits())) {
					return;
