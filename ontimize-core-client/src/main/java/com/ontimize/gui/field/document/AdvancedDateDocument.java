...
public class AdvancedDateDocument extends DateDocument {
	...
	protected void processBetweenSearchValue(SearchValue value) throws BadLocationException {
		...
		this.remove(0, this.getLength());
		AdvancedDateDocument.logger.debug(this.getClass().toString() + "  Inserting: " + stringDate1 + AdvancedDateDocument.BETWEEN + stringDate2);
	...
	protected boolean insertFirstSymbol(int offset, String s, AttributeSet attributes, String symbol) throws BadLocationException {
		if (offset == 1) {
	 ...
	 * {@link #insertString(int, String, AttributeSet)}
	 *
	 * @param s
	 * @param symbol
	 * @return
	...
	protected boolean checkSymbolIsLessMoreEqual(String s, String symbol) {
		return (symbol.equals(AdvancedDateDocument.LESS) || symbol.equals(AdvancedDateDocument.MORE)) && s.equals(AdvancedDateDocument.EQUAL);
	}
	 ...
	 */
	protected void insertStringFollowingThePattern(int offset, String s, AttributeSet attributes) throws BadLocationException {
	 ...
	 * @throws BadLocationException
	 */
	protected void insertStringIfIsDigitAtFIrst(int offset, String s, AttributeSet attributes) throws BadLocationException {
		if (Character.isDigit(s.charAt(0))) {
	 ...
	 * @throws BadLocationException
	 */
	protected void insertStringCharacterOneByOne(int offset, String s, AttributeSet attributes) throws BadLocationException {
		if (s.length() > 1) {
	...
	protected boolean isStartSymbol(String s) {
		if (s.equals(AdvancedDateDocument.LESS) || s.equals(AdvancedDateDocument.MORE) || s.equals(AdvancedDateDocument.NOT) || s.equals(AdvancedDateDocument.LESS_EQUAL) || s
				.equals(AdvancedDateDocument.MORE_EQUAL) || s.equals(AdvancedDateDocument.EQUAL)) {
			return true;
		} else {
			return false;
		}
	...
	protected boolean isSymbolFirst() throws BadLocationException {
		if ((this.getLength() > 0) && (this.getText(0, 1).equals(AdvancedDateDocument.LESS) || this.getText(0, 1).equals(AdvancedDateDocument.MORE) || this.getText(0, 1)
				.equals(AdvancedDateDocument.NOT) || this.getText(0, 1).equals(AdvancedDateDocument.EQUAL))) {
			return true;
		} else {
			return false;
		}
