...
public class ColorDataField extends TextFieldDataField {
	 ...
	 *
	 * @param parameters
	 *            the <code>Hashtable</code> with parameters from XML definition.
	 */
	 ...
	 *            <ul>
	 *            <li>&quot;stringrgb&quot;: Returns a string in decimal format rrr;ggg;bbb (no necessary always 10 characters)</li>
	 *            <li>&quot;stringhex&quot;: Returns a string in hexadecimal format #RRGGBB</li>
	 *            <li>&quot;number&quot;: Returns a Number object. Its value will be R*Math.exp(256, 2) + G*256 + B</li>
	 ...
	 *            <td>yes</td>
	 *            <td>no</td>
	 *            <td>Condition about border of buttons for this field. by default, borders are enabled.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>opaquebuttons</td>
	 *            <td><i>yes/no</td>
	 *            <td>yes</td>
	 *            <td>no</td>
	 *            <td>Condition about opacity of buttons for this field. by default, buttons are opaques.</td>
	 *            </tr>
	 *            <tr>
	 ...
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>Condition about highlight of buttons for this field. by default, hightlight is disabled.</td>
	 *            </tr>
	 *            </TABLE>
	 */
	...
	public void init(Hashtable parameters) {
		...
		if (this.panelColor == null) {
			...
			super.add(this.panelColor,
					new GridBagConstraints(GridBagConstraints.RELATIVE, 0, 2, 1, 2, 2, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		}
		...
		if (this.colorButton == null) {
			...
			super.add(this.colorButton,
					new GridBagConstraints(GridBagConstraints.RELATIVE, 0, 1, 1, 0.0D, 0.0D, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			...
			this.colorButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					String sTitle = ApplicationManager.getTranslation("ColorDataField.chooseColor", ColorDataField.this.parentForm.getResourceBundle());
					Color color = JColorChooser.showDialog(ColorDataField.this, sTitle, ColorDataField.this.getColorValue());
					if (color != null) {
						...
						ColorDataField.this.fireValueChanged(ColorDataField.this.getValue(), ColorDataField.this.valueSave, ValueEvent.USER_CHANGE);
		...
		boolean showTextField = ParseUtils.getBoolean((String) parameters.get(ColorDataField.SHOW_TEXT_FIELD_PROPERTY), true);
		if (!showTextField && (this.dataField != null)) {
			this.dataField.setVisible(false);
		}

		boolean enabledTextField = ParseUtils.getBoolean((String) parameters.get(ColorDataField.ENABLED_TEXT_FIELD_PROPERTY), true);
		if (!enabledTextField) {
		...
		boolean showDeleteButton = ParseUtils.getBoolean((String) parameters.get(ColorDataField.SHOW_DELETE_BUTTON_PROPERTY), true);
	...
	protected class ColorInnerDocumentListener extends InnerDocumentListener {
		 ...
		 *
		 * @param e
		 *            the document change notification
		 */
		@Override
		 ...
		 *
		 * @param enabled
		 *            the condition to enable the inner listener
		 */
		@Override
	 ...
	 *
	 * @param value
	 *            the object where the values(color,number,...) are placed
	 */
	@Override
	public void setValue(Object value) {
		...
		if (ColorDataField.DEBUG) {
			if (this.getValue() != null) {
				ColorDataField.logger.debug("Color " + ((ColorDocument) ((JTextField) super.dataField).getDocument()).getColorValue());
				ColorDataField.logger.debug("StringRGB " + ((ColorDocument) ((JTextField) super.dataField).getDocument()).getRGBStringValue());
				ColorDataField.logger.debug("StringHEX " + ((ColorDocument) ((JTextField) super.dataField).getDocument()).getHEXStringValue());
				ColorDataField.logger.debug("Number " + ((ColorDocument) ((JTextField) super.dataField).getDocument()).getNumericalValue().intValue());
			}
		}
	}
	 ...
	 *
	 * @param enabled
	 *            the condition to enable components
	 */
	@Override
