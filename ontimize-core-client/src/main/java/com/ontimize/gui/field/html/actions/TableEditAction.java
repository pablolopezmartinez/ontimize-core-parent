...
public class TableEditAction extends HTMLTextEditAction {
	...
	private static final String	NAMES[]				= { "HTMLShef.insert_cell", "HTMLShef.delete_cell", "HTMLShef.insert_row", "HTMLShef.delete_row", "HTMLShef.insert_column", "HTMLShef.delete_column" };
