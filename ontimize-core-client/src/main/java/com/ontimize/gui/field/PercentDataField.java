...
public class PercentDataField extends TextFieldDataField {
	...
	/**
	 * The class constructor. It initializes the parameters. By default, the right alignment and if parameter 'size' exists, its values is fixed to 3 in <code>Hashtable</code> .
	 * <p>
	 *
	 * @param parameters
	...
	/**
	 * If value is a number, its value is set to 'value'. It must be between 0 and 1. In other case, deletes the field value.
	 * <p>
	 *
	 * @param value
	 *            the object to set values
	 */
	@Override
