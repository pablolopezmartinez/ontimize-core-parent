...
/**
 * This class implements a field with a calendar component. This calendar will be sensible to listeners and value changes.
 * <p>
 *
 * @author Imatia Innovation
 */
public class CalendarDataField extends IdentifiedAbstractFormComponent implements ValueChangeDataComponent, CalendarListener {
	...
	public void init(Hashtable parameters) {
		...
		super.add(this.calendarComp, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
	}
	 ...
	 *
	 * @param l
	 *            the mouse listener reference to add
	 */
	 ...
	 *
	 * @param l
	 *            the mouse listener reference to remove
	 */
