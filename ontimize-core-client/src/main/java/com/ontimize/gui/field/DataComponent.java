...
public interface DataComponent extends FormComponent, IdentifiedElement {
	 ...
	 *
	 * @param value
	 *            the <code>object</code> with value to set
	 */
	...
	/**
	 * Establishes the modifiable condition for a component. When component is not modifiable, data will not be deleted automatically in <code>DeleteFields</code> call.
	 * <p>
	 *
	 * @param modifiable
	...
	/**
	 * This method should be return <code>true</code> when data have been modified. The method <code>setValue()</code> should be change this condition.
	 * <p>
	 *
