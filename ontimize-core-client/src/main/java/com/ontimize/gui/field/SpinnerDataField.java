...
/**
 * Field similar to <code>JSpinner</code> that allows to modify value (increasing/decreasing) with two selectors. <br>
 * <br>
...
public class SpinnerDataField extends DataField {
	...
	protected class InnerListener implements ChangeListener {
		...
		public void stateChanged(ChangeEvent e) {
			if (this.innerListenerEnabled) {
				SpinnerDataField.this.fireValueChanged(SpinnerDataField.this.getValue(), this.storeInnerValue, ValueEvent.USER_CHANGE);
	 ...
	 *
	 * @param parameters
	 *            the <code>Hashtable</code> with parameters. Allows the next parameters:
	 *            <p>
	...
	public void init(Hashtable parameters) {
		...
		if (this.dataField instanceof JSpinner) {
			...
			if (this.values != null) {
				...
				CustomSpinnerNumberModel spinnerNumberModel = new CustomSpinnerNumberModel(this.numberclass, (Number) initialValue, (Comparable) minValue, (Comparable) maxValue,
						(Number) stepValue);
	...
	protected void createDataField() {
		EJSpinner spinner = new EJSpinner() {
			...
			public Dimension getPreferredSize() {
				...
				char charMaxWidth = ((JSpinner) SpinnerDataField.this.dataField).getModel() instanceof SpinnerNumberModel ? '0' : 'W';
				return new Dimension((SpinnerDataField.this.fieldSize * this.getFontMetrics(this.getFont()).charWidth(charMaxWidth)) + buttonsWidth,
