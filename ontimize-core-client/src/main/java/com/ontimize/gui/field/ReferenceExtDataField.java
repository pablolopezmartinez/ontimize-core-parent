...
public class ReferenceExtDataField extends TextFieldDataField
        implements OpenDialog, Internationalization, Freeable, CreateForms, CachedComponent, IFilterElement,
        ReferenceDataComponent, ITemplateField {
    ...
    /**
     * The last cache time. By default, 0. With this default value, it is checked the first time that
     * window is opened.
     */
    ...
    /**
     * The condition about code will be cleared when not matches with existing value. By default, code
     * will be cleared.
     *
     * @since 5.2068EN
     */
    ...
    protected static class MultipleResultWindow {
        ...
        public MultipleResultWindow(Table t, final ReferenceDataComponent referenceDataComponent,
                ...
                this.queryButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (res.getCode() == EntityResult.OPERATION_WRONG) {
                            referenceDataComponent.getParentForm()
                                .message(MultipleResultWindow.this.dSelec, res.getMessage(), Form.ERROR_MESSAGE);
                        } else {
            ...
            this.multipleResultTable.getJTable()
                .getSelectionModel()
        ...
        protected Object showResultSelectionWindow(final EntityResult res,
            ...
            this.lInfo
                .setText(ApplicationManager.getTranslation(ReferenceExtDataField.ResultSelectionInfoKey, resources));
                ...
                if (ReferenceExtDataField.this.tableWindow == null) {
                    ...
                    if ((ReferenceExtDataField.this.windowTitle != null)
                        ...
                        ReferenceExtDataField.this.tableWindow
                            .setTitle(ApplicationManager.getTranslation(ReferenceExtDataField.this.windowTitle,
                                    ReferenceExtDataField.this.resources));
                    } else if (ReferenceExtDataField.this.windowTitle != null) {
                    ...
                    if (ReferenceExtDataField.this.tableWindow.auxCodeLabel != null) {
                        ReferenceExtDataField.this.tableWindow.auxCodeLabel
                            .setText(ApplicationManager.getTranslation(ReferenceExtDataField.auxCodeLabelKey,
                                    ReferenceExtDataField.this.resources));
                    }
     ...
     * <td></td>
     * <td>no</td>
     * <td>Specifies the type number object used. It is only available when codnumber is setted.</td>
     * </tr>
     * <tr>
     * <td>csize</td>
     * <td></td>
     ...
     * -User has a reference field that queries an entity with three fields ID;INITIALDATE;ENDDATE. ID
     * is the code of field.<br>
     * -User wants to format description of this field to show: Period starts: <i>INITIALDATE</i> and
     * ends: <i>ENDDATE</i><br>
     * -He only needs to store in bundle a key, e.g., refExtKey= Period starts: {0} and ends: {1} and
     * the 'translation' parameter to 'yes' value<br>
     ...
     * <td>yes</td>
     * <td>no</td>
     * <td>Visible table columns in text field. By default, it is the parameter value of visiblecols in
     * table.</td>
     * </tr>
     * <tr>
     * <td>querycols</td>
     ...
     * <td>yes</td>
     * <td>no</td>
     * <td>Indicates whether code field should be reset when query did not return any match for current
     * code value.</td>
     * </tr>
     * </Table>
     * <p>
    ...
    public EntityResult queryBy(String column, Object value) {
        ...
        try {
            ...
            EntityResult result = this.locator.getEntityReference(this.entityName)
                .query(keysValues, this.getAttributes(), this.locator.getSessionId());
    ...
    protected EntityResult queryByCode(Object code) {
        ...
        try {
            ...
            if (ApplicationManager.DEBUG_TIMES) {
                ReferenceExtDataField.logger
                    .debug(this.getClass().getName() + ": Time in queryByCode(): " + (System.currentTimeMillis() - t));
            }
            if (result.getCode() == EntityResult.OPERATION_WRONG) {
                if (ApplicationManager.DEBUG) {
                    ReferenceExtDataField.logger.debug(result.getMessage());
    ...
    public void setValue(Object value, boolean inner) {
        ...
        try {
            ReferenceExtDataField.logger.debug(": " + this.getAttribute() + ": setValue() : value: " + value
                    + " : cachetime" + this.cacheTime + " , usecachemanager: "
            ...
            if (this.cacheTime > 0) {
                ...
                if (value instanceof Hashtable) {
                    ...
                    if (vCodes == null) {
                        ReferenceExtDataField.logger
                            .debug(this.getClass().toString() + " : " + this.getAttribute() + " Data for code "
                                    + this.code + " have not been encountered: " + this.dataCache);
                    }
                    ...
                    if (!cod.equals(oValue)) {
                        ReferenceExtDataField.logger
                            .debug(this.getClass().toString() + ": setValue() : value: " + oValue
                                    + " : There is no cache. It has been queried by code and returned value = "
                                    + cod
                                    + " does not fulfil the equals() condition with indicated value : Passed value: "
                                    + oValue.getClass() + " , class of returned value: "
                                    + cod.getClass());
                        ReferenceExtDataField.logger
    ...
    protected void setValueIfNotExistCacheData(boolean inner, Object oPreviousValue, Object oValue) {
        ...
        if (res.isEmpty() || (res.getCode() == EntityResult.OPERATION_WRONG)) {
            ...
            if (vCodes.contains(oValue)) {
                if (ApplicationManager.DEBUG) {
                    ReferenceExtDataField.logger
                        .debug(this.getClass().toString() + ": " + this.getAttribute() + ": setValue() : value: "
                                + oValue + " : Code is not stored in cache");
                }
                    ...
                    Thread th = new Thread("Initialize cache manager for : " + this.entityName) {
                        ...
                        public void run() {
                            ...
                            EntityResult er = ReferenceExtDataField.this.cacheManager.getDataCache(
                                    ReferenceExtDataField.this.entityName,
    ...
    /**
     * Returns the SQL type of varchar or integer in function of {@link #integerValue}.
     * <p>
        ...
        try {
            if (this.tableWindow != null) {
                ...
                if (this.tableWindow.auxCodeLabel != null) {
                    this.tableWindow.auxCodeLabel
                        .setText(ApplicationManager.getTranslation(ReferenceExtDataField.auxCodeLabelKey, resources));
                }
            }
        } catch (Exception e) {
    ...
    /**
     * Returns the condition expressed in parameter 'clearquickfilter'. When it is true, quickfilter
     * field will be showed empty when result table is showed. When it is false, the last filter typed
     * is maintained in quickfilter.
    ...
    public static class QueryPopup extends JPopupMenu {
        ...
        /**
         * Creates the JList used in the popup to display the items in the combo box model. This method is
        ...
        protected JPanel createWaitPanel() {
            ...
            panel.add(new RotatedLabel(ImageManager.getIcon("loading.png")),
                    new GridBagConstraints(0, 0, 1, 1, 0, 1, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL,
        ...
        /**
         * Configures the popup portion of the combo box. This method is called when the UI class is
         * created.
         */
