...
public class MaskDocument extends PlainDocument {
	...
	protected void insertOtherString(int offset, String stringValue, AttributeSet attributes) throws BadLocationException {
		int length;
	...
	protected void insertAnyString(int offset, String stringValue, AttributeSet attributes, int length) throws Exception {
	...
	protected void insertDigitString(int offset, String stringValue, AttributeSet attributes, int length) throws Exception {
		// Digits
		if (!Character.isDigit(stringValue.charAt(0))) {
			return;
		} else {
	...
	protected void insertLowerAString(int offset, String stringValue, AttributeSet attributes, int length) throws Exception {
	...
	protected void insertUpperAString(int offset, String stringValue, AttributeSet attributes, int length) throws Exception {
	...
	protected void insertAsteriskString(int offset, String stringValue, AttributeSet attributes, int length) throws Exception {
	...
	protected void insertHashString(int offset, String stringValue, AttributeSet attributes, int length) throws Exception {
