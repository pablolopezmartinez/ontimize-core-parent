...
/**
 * The main class to implement a combo with the months. This combo is locale sensitive, if it is not specified, default locale is used.
 * <p>
 *
...
public class MonthComboDataField extends TextComboDataField {
	...
	/**
	 * The class constructor. Calls to <code>super()</code> with parameters and creates an instance of a <code>Gregorian Calendar</code>.
	 * <p>
	 *
	 * @param parameters
	 ...
	 *
	 * @param value
	 *            an integer instance to indicate the month
	 */
	@Override
