...
public class CIFDocument extends MaskDocument {
    ...
    /**
     * Constructor. Uses the #MaskDocument constructor, with the correct mask to insert the CIF, this
     * is: A0000000%
     */
    public CIFDocument() {
        super("A0000000%");
     ...
     * 1 - Remove the first and the last character in the CIF (first letter and control character), this
     * return a string with 7 digits. <br>
     * 2- Sum all digits in even position, getting a result whose name will be A <br>
     * 3- For each digit in a odd position multiply it by 2, sum the result digits and store this value
     * whose name will be B.<br>
     * 4- Sum A and B getting the result C.<br>
     * 5 - Get the units digit of C and subtract it from 10 (10 - C units digit) getting D. <br>
     * 6 - Using this result D is possible to obtain the control character. If control character must be
     * a numeric value, this is directly D. If control character must be a letter the equivalence is
     * 1-->A, 1 -->B etc. <br>
     * <br>
