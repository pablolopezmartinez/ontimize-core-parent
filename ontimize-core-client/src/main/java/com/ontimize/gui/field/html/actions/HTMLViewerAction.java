...
/**
 * This action shows a panel with the xml that represent the current value of the diagram component. The default diagram class {@link DiagramGUI} registers the keys
 * CTRL+ALT+SHIFT+X as shortcut to this action.
 *
