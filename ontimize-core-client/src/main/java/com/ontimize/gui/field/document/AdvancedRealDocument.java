...
public class AdvancedRealDocument extends RealDocument {
	...
	protected boolean isStartSymbol(String s) {
		if (s.equals(AdvancedRealDocument.LESS) || s.equals(AdvancedRealDocument.MORE) || s.equals(AdvancedRealDocument.NOT) || s.equals(AdvancedRealDocument.LESS_EQUAL) || s
				.equals(AdvancedRealDocument.MORE_EQUAL) || s.equals(AdvancedRealDocument.EQUAL)) {
			return true;
		} else {
			return false;
		}
	...
	protected boolean isSymbolFirst() throws BadLocationException {
		if ((this.getLength() > 0) && (this.getText(0, 1).equals(AdvancedRealDocument.LESS) || this.getText(0, 1).equals(AdvancedRealDocument.MORE) || this.getText(0, 1)
				.equals(AdvancedRealDocument.NOT) || this.getText(0, 1).equals(AdvancedRealDocument.EQUAL))) {
			return true;
		} else {
			return false;
		}
	...
	protected void insertFirstSymbol(int offset, String s, AttributeSet attributes, char decimalSeparator) throws BadLocationException {
		String symbol = this.getDocumentFirstSymbol();
	 ...
	 * @throws BadLocationException
	 */
	protected void insertStringIfOffsetIsNot1AndFirstCharacterIsNotASymbol(int offset, String s, AttributeSet attributes) throws BadLocationException {
		String currentText = this.getText(0, this.getLength());
	...
	protected boolean checkIfSymbolIsLessMoreEqual(String s, String symbol) {
		return (symbol.equals(AdvancedRealDocument.LESS) || symbol.equals(AdvancedRealDocument.MORE)) && s.equals(AdvancedRealDocument.EQUAL);
	}
