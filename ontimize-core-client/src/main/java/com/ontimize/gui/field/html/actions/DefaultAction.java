...
public class DefaultAction extends BasicAction implements EnabledUpdater {
    ...
    public DefaultAction(String id, String shortDesc, String longDesc, Integer mnemonic, KeyStroke accelerator,
            Icon icon) {
        this(id, id, id, shortDesc, longDesc, mnemonic, accelerator, icon);
    }

    public DefaultAction(String id, String actionName, String actionCommandName, String shortDesc, String longDesc,
    ...
    public DefaultAction(String id, String actionName, String actionCommandName, String shortDesc, String longDesc,
        ...
        super(id, actionName, actionCommandName, shortDesc, longDesc, mnemonic, accelerator, icon, toolbarShowsText,
                menuShowsIcon);
    }
    ...
    /**
     * Catch all for anything thrown in the execute() method. This implementation shows an
     * ExceptionDialog. (non-Javadoc)
     *
