...
/**
 * Interface that determines the methods that controls the navigation among records of forms. Notifies when a record is going to check to perform the necessary operations if the
 * change is not permitted and notifies when a change was performed.
 */
