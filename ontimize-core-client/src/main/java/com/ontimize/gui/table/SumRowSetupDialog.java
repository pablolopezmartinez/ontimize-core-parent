...
public class SumRowSetupDialog extends EJDialog implements Internationalization {
	...
	protected void installOperationMenu() {
		...
		this.sumMenu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				SumRowSetupDialog.SelectableFunctionItem it = (SumRowSetupDialog.SelectableFunctionItem) SumRowSetupDialog.this.columnsList.getModel()
	...
	protected void init(Table t) {
		...
		this.columnsList.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				try {
					SumRowSetupDialog.this.indexPress = SumRowSetupDialog.this.columnsList.locationToIndex(e.getPoint());
					...
					SelectableItemRenderer.SelectableItem it = (SelectableItemRenderer.SelectableItem) SumRowSetupDialog.this.columnsList.getModel()
							.getElementAt(SumRowSetupDialog.this.indexPress);
					...
					Rectangle rect = SumRowSetupDialog.this.columnsList.getCellBounds(SumRowSetupDialog.this.indexPress, SumRowSetupDialog.this.indexPress);
	...
	protected JPanel getButtonsPanel() {
		...
		this.labelHelp = new JLabel(ApplicationManager.getTranslation(SumRowSetupDialog.helpDialogMessage, this.bundle));
		...
		aux.add(this.labelHelp,
				new GridBagConstraints(0, 0, GridBagConstraints.REMAINDER, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		...
		aux.add(this.okButton, new GridBagConstraints(0, 1, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		this.okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < SumRowSetupDialog.this.columnsList.getModel().getSize(); i++) {
					if (SumRowSetupDialog.this.columnsList.getModel().getElementAt(i) instanceof SumRowSetupDialog.SelectableFunctionItem) {
						SumRowSetupDialog.SelectableFunctionItem col = (SumRowSetupDialog.SelectableFunctionItem) SumRowSetupDialog.this.columnsList.getModel().getElementAt(i);
						if (col.isSelected()) {
		...
		aux.add(this.resetButton, new GridBagConstraints(1, 1, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
