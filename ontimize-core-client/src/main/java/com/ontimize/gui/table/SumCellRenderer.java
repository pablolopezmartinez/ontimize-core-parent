...
public class SumCellRenderer extends com.ontimize.gui.table.RealCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean hasFocus, int row, int column) {
		...
		if ((value == null) && (c instanceof JComponent)) {
			((JComponent) c).setBackground(SumCellRenderer.disabledBackgroundColor != null ? SumCellRenderer.disabledBackgroundColor : DataComponent.VERY_LIGHT_GRAY);
			((JComponent) c).setToolTipText(null);
		} else {
			c.setForeground(SumCellRenderer.foregroundColor != null ? SumCellRenderer.foregroundColor : SumCellRenderer.defaultForegroundColor);
