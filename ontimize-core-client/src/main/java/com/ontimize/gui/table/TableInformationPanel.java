...
public class TableInformationPanel extends JPanel {
	...
	protected void build() {
		...
		this.add(filler, new GridBagConstraints(0, row++, 0, 3, 1, 2, GridBagConstraints.NORTH, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
		this.add(labelTitle, new GridBagConstraints(0, row++, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(this.topOffset, 0, 0, 0), 0, 0));
		this.add(scroll, new GridBagConstraints(0, row++, 1, 1, 1, 8, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 30, 0, 30), 0, 0));
		this.add(filler2, new GridBagConstraints(0, row++, 1, 1, 1, 1, GridBagConstraints.SOUTH, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
