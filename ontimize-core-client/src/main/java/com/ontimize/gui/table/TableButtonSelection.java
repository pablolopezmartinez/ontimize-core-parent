 ...
 */
public class TableButtonSelection extends ButtonSelection implements Internationalization, TableComponent, Transferable, DragGestureListener, DragSourceListener {
	...
	public DataFlavor[] getTransferDataFlavors() {
		try {
			return new DataFlavor[] { new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType + ";class=\"" + TableButtonSelection.class.getName() + "\"") };
