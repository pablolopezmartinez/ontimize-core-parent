...
public class VisibleColsSetupDialog extends EJDialog implements Internationalization {
	...
	protected void init(Table t) {
		...
		this.colsList.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				try {
					...
					SelectableItemRenderer.SelectableItem it = (SelectableItemRenderer.SelectableItem) VisibleColsSetupDialog.this.colsList.getModel().getElementAt(index);
			...
			public void keyReleased(KeyEvent e) {
				...
				if ((e.getKeyCode() == 40) || (e.getKeyCode() == 38)) {
					...
					if (VisibleColsSetupDialog.this.colsList.getSelectedIndices().length != 1) {
						...
						VisibleColsSetupDialog.this.checkSelectPosition(VisibleColsSetupDialog.this.colsList.getSelectedIndex());
					}
				}
			}
		...
		aux.add(new JScrollPane(this.colsList),
				new GridBagConstraints(0, 1, 1, GridBagConstraints.REMAINDER, 1, 1, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		aux.add(this.getSelectionButtonsPanel(), new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.buttonSaveColsPositionWidth.setMargin(new Insets(0, 0, 0, 0));
		aux.add(this.buttonSaveColsPositionWidth,
				new GridBagConstraints(1, 2, 1, GridBagConstraints.REMAINDER, 0, 0, GridBagConstraints.SOUTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
	...
	protected void applyChanges() {
		...
		for (int i = 0; i < this.colsList.getModel().getSize(); i++) {
			if (this.colsList.getModel().getElementAt(i) instanceof SelectableItemRenderer.SelectableItem) {
				String col = ((SelectableItemRenderer.SelectableItem) this.colsList.getModel().getElementAt(i)).getText();
				...
				if (originalIndex != i) {
					...
					if (originalIndex<this.table.getBlockedColumnIndex()) {
						this.table.getBlockedTable().moveColumn(this.table.getColumnIndex(col), this.table.getColumnIndex((String) vOriginalPosition.elementAt(i)));
					}else {
						this.table.getJTable().moveColumn(this.table.getColumnIndex(col), this.table.getColumnIndex((String) vOriginalPosition.elementAt(i)));
					}
	...
	public void setColumn() {
		...
		for (int i = 0; i < act.size(); i++) {
			SelectableItemRenderer.SelectableItem item = new SelectableItemRenderer.SelectableItem((String) act.get(i), resourceBundle);
	...
	protected JPanel getSelectionButtonsPanel() {
		JPanel aux = new JPanel(new GridBagLayout());
		aux.add(this.allUp, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.allUp.setMargin(new Insets(0, 0, 0, 0));
		this.allUp.setEnabled(false);
		aux.add(this.up, new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.up.setMargin(new Insets(0, 0, 0, 0));
		this.up.setEnabled(false);
		aux.add(this.down, new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.down.setMargin(new Insets(0, 0, 0, 0));
		this.down.setEnabled(false);
		aux.add(this.allDown, new GridBagConstraints(0, 3, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		this.allDown.setMargin(new Insets(0, 0, 0, 0));
		this.allDown.setEnabled(false);

		aux.add(this.buttonSelection, new GridBagConstraints(0, 4, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		aux.add(this.buttonDeselect, new GridBagConstraints(0, 5, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		aux.add(this.buttonReplace, new GridBagConstraints(0, 6, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
	...
	public void setResourceBundle(ResourceBundle res) {
		this.setTitle(ApplicationManager.getTranslation(VisibleColsSetupDialog.INFO_KEY, this.table.getResourceBundle()));
		...
		if ((this.table == null) || this.table.isTranslateHeader()) {
			for (int i = 0; i < this.colsList.getModel().getSize(); i++) {
				if (this.colsList.getModel().getElementAt(i) instanceof SelectableItemRenderer.SelectableItem) {
					((SelectableItemRenderer.SelectableItem) this.colsList.getModel().getElementAt(i)).setResourceBundle(this.table.getResourceBundle());
				}
			}
		}
		...
		this.buttonSelection.setToolTipText(ApplicationManager.getTranslation(VisibleColsSetupDialog.SELECTION_KEY, res));
		this.buttonDeselect.setToolTipText(ApplicationManager.getTranslation(VisibleColsSetupDialog.DESELECTION_KEY, res));
		...
		this.buttonSaveColsPositionWidth.setToolTipText(ApplicationManager.getTranslation(VisibleColsSetupDialog.SAVE_POSITION_AND_WIDTH, res));
	}
