...
/**
 * Class that contains the GUI to filter the table. This class is accessed by the table when some event of filtering is launched, opening the dialog in the corresponding
 * configuration, in order to perform the filtering in the model.
 */
public class FilterDialog extends EJDialog implements Internationalization, ActionListener {
		...
		protected class FilterModel extends javax.swing.AbstractListModel {
			...
			public Object getElementAt(int index) {
				if (this.filterValue instanceof MultipleFilter) {
					...
					return new FiltroItem(index == 0 ? null : ((MultipleFilter) this.filterValue).getCondition(index), o);
				} else {
	...
	ActionListener actionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			if (FilterDialog.this.conditions.getSelectedIndex() != Filter.RANGE) {
				FilterDialog.this.field.getLabelComponent().setText(ApplicationManager.getTranslation("table.value", FilterDialog.this.bundle) + " ");
				...
				if (FilterDialog.this.fieldLessDate.isVisible()) {
					...
					FilterDialog.this.fieldLessDate.getLabelComponent().setText(ApplicationManager.getTranslation("filtercomponent.between", FilterDialog.this.bundle) + " ");
					FilterDialog.this.fieldGreaterDate.getLabelComponent().setText(ApplicationManager.getTranslation("Y", FilterDialog.this.bundle) + " ");
				}
				if (FilterDialog.this.fieldLessInteger.isVisible()) {
					...
					FilterDialog.this.fieldLessInteger.getLabelComponent().setText(ApplicationManager.getTranslation("filtercomponent.between", FilterDialog.this.bundle) + " ");
					FilterDialog.this.fieldGreaterInteger.getLabelComponent().setText(ApplicationManager.getTranslation("Y", FilterDialog.this.bundle) + " ");
				}
				if (FilterDialog.this.fieldLessReal.isVisible()) {
					...
					FilterDialog.this.fieldLessReal.getLabelComponent().setText(ApplicationManager.getTranslation("filtercomponent.between", FilterDialog.this.bundle) + " ");
					FilterDialog.this.fieldGreaterReal.getLabelComponent().setText(ApplicationManager.getTranslation("Y", FilterDialog.this.bundle) + " ");
				}
	...
	protected JPanel getColumnListPanel() {
		...
		this.columnPanel.setBorder(new javax.swing.border.TitledBorder(ApplicationManager.getTranslation(this.COLUMN, this.bundle)));
	...
	protected JPanel getPanelsWithFilterList() {
		...
		this.filterPanel.setBorder(new javax.swing.border.TitledBorder(ApplicationManager.getTranslation(this.FILTER, this.bundle)));
	...
	protected JPanel getSelectionFilterPanel() {
		...
		pButtonsPanel.add(this.cbNotNull, new GridBagConstraints(0, 0, 2, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pButtonsPanel.add(this.cbNull, new GridBagConstraints(2, 0, 4, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));

		pButtonsPanel.add(this.filterConditions, new GridBagConstraints(0, 1, 2, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pButtonsPanel.add(this.buttonAdd, new GridBagConstraints(2, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
		pButtonsPanel.add(this.buttonEdit, new GridBagConstraints(3, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
		pButtonsPanel.add(this.buttonDelete, new GridBagConstraints(4, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
		pButtonsPanel.add(this.buttonDeleteAll, new GridBagConstraints(5, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
		...
		pConfiguracion.add(this.cdDistinct,
				new GridBagConstraints(0, 0, GridBagConstraints.RELATIVE, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));

		pConfiguracion.add(this.conditionLabel, new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(1, 1, 1, 5), 0, 0));
		pConfiguracion.add(this.conditions,
				new GridBagConstraints(1, 1, GridBagConstraints.REMAINDER, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldLessDate, new GridBagConstraints(0, 2, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldGreaterDate, new GridBagConstraints(3, 2, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldLessInteger, new GridBagConstraints(0, 3, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldGreaterInteger,
				new GridBagConstraints(3, 3, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldLessReal, new GridBagConstraints(0, 4, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldGreaterReal, new GridBagConstraints(3, 4, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldCheck, new GridBagConstraints(0, 5, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldText, new GridBagConstraints(0, 6, 3, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
		pConfiguracion.add(this.fieldInteger, new GridBagConstraints(0, 7, 1, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));

		this.dMY.add(this.cbDay);
		this.dMY.add(this.cbMonth);
		this.dMY.add(this.cbYear);

		pConfiguracion.add(this.dMY, new GridBagConstraints(1, 7, 2, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(1, 1, 1, 1), 0, 0));
	...
	protected JPanel getControlButtonsPanel() {
		...
		aux.add(this.buttonOk, new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));

		aux.add(this.buttonReset, new GridBagConstraints(1, 0, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
	...
	protected void init(Table table) {
		...
		rightPanel.add(this.selectionFilterPanel, new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		rightPanel.add(this.controlButtonsPanel, new GridBagConstraints(1, 2, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
	...
	protected void insertNotRangeFilter(boolean modif) {
		...
		case Filter.LESS:
			...
			if ((this.filterList.getSelectedIndex() == -1) || !modif) {
				...
				this.filterList.setFilter(this.filterConditions.getSelectedItem(), filter, this.filterList.getSelectedIndex());
			}
			return;
	...
	private void checkDateDataField(Object[] values) {
		if ((this.field instanceof DateDataField) && (this.conditions.getSelectedIndex() == Filter.LESS_EQUAL) && (values[0] instanceof Date)) {
	...
	public void insertFilter(boolean modif) {
		...
		if (((this.field == this.fieldLessDate) || (this.field == this.fieldLessInteger) || (this.field == this.fieldLessReal))	&& (this.conditions
	...
	protected Object checkAsterisk() {
		...
		if ((value instanceof String) && ((String) value).endsWith("*")) {} else if (value instanceof Boolean) {} else {
			value = (String) value + "*";
		}
		return value;
	}
	...
	protected void insertDateFilter(boolean modif) {
		if (this.conditions.getSelectedIndex() == Filter.RANGE) {
			...
			if ((this.filterList.getSelectedIndex() == -1) || !modif) {
				...
				this.filterList.setFilter(this.filterConditions.getSelectedItem(), filterValue, this.filterList.getSelectedIndex());
			}
			return;
		} else {
			return;
	...
	protected void insertNotNullFilter(boolean modif) {
		if ((this.filterList.getSelectedIndex() == -1) || !modif) {
			...
			this.filterList.setFilter(this.filterConditions.getSelectedItem(), new DifferentSimpleFilter(null), this.filterList.getSelectedIndex());
		}
	...
	protected void insertLastFilter(boolean modif) {
		...
		if ((this.filterList.getSelectedIndex() == -1) || !modif) {
			this.filterList.addFilter(this.filterConditions.getSelectedItem(), new DateFilter(type, ((Integer) desc).intValue(), this.bundle));
		} else {
			this.filterList.setFilter(this.filterConditions.getSelectedItem(), new DateFilter(type, ((Integer) desc).intValue(), this.bundle), this.filterList.getSelectedIndex());
		}
		this.filterList.clearSelection();
	}
	...
	protected void insertNullFilter(boolean modif) {
		if ((this.filterList.getSelectedIndex() == -1) || !modif) {
			...
			this.filterList.setFilter(this.filterConditions.getSelectedItem(), new SimpleFilter(null), this.filterList.getSelectedIndex());
		}
		this.filterList.clearSelection();
	...
	protected void configureByTypeOfColumn(int viewColumn) {
		...
		if ((this.table.getJTable().getCellRenderer(0, viewColumn) != null) && (this.table.getJTable().getCellRenderer(0, viewColumn) instanceof ComboReferenceCellRenderer)) {
			columClass = String.class;
		}

		if ((columClass == java.util.Date.class) || (columClass == java.sql.Date.class) || (columClass == java.sql.Timestamp.class)) {
			...
			this.setLast(false);
			this.fieldInteger.setVisible(false);
		} else if ((columClass == Number.class) || (columClass == Float.class) || (columClass == Double.class) || (columClass == BigDecimal.class) || (columClass == BigInteger.class)) {
	...
	public void updateFilterInfo() {
		this.lInfo.setText(ApplicationManager.getTranslation("table.filter", this.bundle) + ": " + this.getFilterInfo());
	...
	public void show(MouseEvent e) {
		...
		this.setSize(d);
		Point p = new Point(Math.min(e.getX(), Toolkit.getDefaultToolkit().getScreenSize().width - ((JComponent) e.getSource()).getLocationOnScreen().x - this.getWidth()),
				Math.min(e.getY(), Toolkit.getDefaultToolkit().getScreenSize().height - ((JComponent) e.getSource()).getLocationOnScreen().y - this.getHeight()));
