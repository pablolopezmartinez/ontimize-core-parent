...
public class TableWaitPanel extends JPanel {
	...
	protected void build() {
		...
		centerPanel.add(label, new GridBagConstraints(0, 0, 1, 1, 1, 1, GridBagConstraints.SOUTH, GridBagConstraints.NONE, new Insets(0, 0, 10, 0), 0, 0));
		centerPanel.add(cancelButton, new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 10, 0));

		// centerPanel.setBorder(new LineBorder(Color.red));
		// label.setBorder(new LineBorder(Color.yellow));

		this.add(filler, new GridBagConstraints(0, 0, 0, 2, 1, 1, GridBagConstraints.NORTH, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
		this.add(centerPanel, new GridBagConstraints(0, 1, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		this.add(filler2, new GridBagConstraints(0, 2, 1, 1, 1, 1, GridBagConstraints.SOUTH, GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
