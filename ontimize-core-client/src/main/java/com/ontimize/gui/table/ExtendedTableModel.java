...
public class ExtendedTableModel extends AbstractTableModel {
     ...
     */
    @Deprecated
    public ExtendedTableModel(Hashtable tableData, Vector columnNames, Vector columnTexts,
            Hashtable calculatedColumns) {
     ...
     */
    @Deprecated
    public ExtendedTableModel(Hashtable tableData, Vector columNames, Vector columnTexts, Hashtable calculatedColumns,
            boolean editable) {
     ...
     * are vectors with each column data. It is possible that the vector contains null values.
     *
     * @deprecated
     */
    public ExtendedTableModel(Hashtable tableData, Vector columnNames, Vector columnTexts, Hashtable calculatedColumns,
            boolean editable, Vector colsReqCalc) {
    ...
    protected Object getValue(int row, int column) {
        if (column < this.columnNames.size()) {
            ...
            Hashtable rowValuesForExpression = this.getRowValuesForExpression(
            ...
            if (((oKeyValue == null) && (vKey == null)) || oKeyValue.equals(vKey.get(i))) {
                ...
                if (keysMatch) {
                    ...
                    while (enumKeys.hasMoreElements()) {
                        ...
                        if (vData.size() <= i) {
                            ExtendedTableModel.logger
                                .debug(this.getClass().toString() + " -> Data vector for the column: " + oKeyl
