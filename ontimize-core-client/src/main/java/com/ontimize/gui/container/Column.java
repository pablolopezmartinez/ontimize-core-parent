...
public class Column extends JPanel implements FormComponent, IdentifiedElement, AccessForm, Freeable {
	 ...
	 *            <td><code></code></td>
	 *            <td>no</td>
	 *            <td>Indicates whether the component placed in the bottom of column will be expanded and take up all remaining column space.</td>
	 *            </tr>
	 *            <tr>
	 *            <td>title</td>
	 *            <td></td>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>The color of the border ColorTitleBorder. A possible color for {@link ColorConstants} or a RGB value like: '150;230;23'</td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>visible</td>
		...
		if (bgcolor != null) {
			...
			if (bg.indexOf(";") > 0) {
				try {
					...
					Column.logger.error(this.getClass().toString() + ": Error in parameter 'bgcolor': " + e.getMessage(), e);
				}
			} else {
				try {
