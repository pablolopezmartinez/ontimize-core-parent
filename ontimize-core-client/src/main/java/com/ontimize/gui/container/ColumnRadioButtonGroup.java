...
public class ColumnRadioButtonGroup extends Column {
	...
	public void init(Hashtable parameters) {
		...
		if (this.title != null) {
			...
			/*
			 * if ((border != null) && (border instanceof TitledBorder)) { ((TitledBorder) border).setTitleColor(Color.blue); ((TitledBorder) border).setBorder(new
		...
		if (selected != null) {
			...
			ColumnRadioButtonGroup.logger.debug(this.getClass().toString() + " .Info: 'selected' parameter hasn't been specified");
		}
	}
