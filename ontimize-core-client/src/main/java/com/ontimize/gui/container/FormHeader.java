...
public class FormHeader extends AbstractFormComponent {
	 ...
	 * <td>yes</td>
	 * <td>yes</td>
	 * <td>The standard buttons definition. Default value could be changed with: {@link Form#STANDARD_BUTTONS}</td>
	 * </tr>
	 *
	 * <tr>
	 * <td>separator</td>
	...
	public void init(Hashtable params) {
		...
		this.labelTextButtons = ParseUtils.getBoolean((String) params.get(FormHeader.TEXT), FormHeader.useTextInButtons);
	...
	public Object getConstraints(LayoutManager parentLayout) {
		if (parentLayout instanceof GridBagLayout) {
			return new GridBagConstraints(GridBagConstraints.RELATIVE, 0, 1, 1, 0, 0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0);
		} else {
			return null;
		}
	}
