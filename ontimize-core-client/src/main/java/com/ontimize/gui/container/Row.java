...
/**
 * This class creates a panel and places the components in form of a
 * <code>row</code>.
 * <p>
 *
 * @author Imatia Innovation
 */
public class Row extends JPanel implements FormComponent, Internationalization, IdentifiedElement, AccessForm, Freeable {
	...
	public Object getConstraints(LayoutManager parentLayout) {
		if (parentLayout instanceof GridBagLayout) {
			if (this.verticalWeight != null) {
				return new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1, this.verticalWeight.doubleValue(), GridBagConstraints.NORTH, GridBagConstraints.BOTH,
						new Insets(0, 0, 0, 0), 0, 0);
			} else if (!this.verticalExpand) {
				return new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1, 0, GridBagConstraints.NORTH, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0);
			} else {
				return new GridBagConstraints(0, GridBagConstraints.RELATIVE, 1, 1, 1, 1, GridBagConstraints.NORTH, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0);
			}
		} else {
			return null;
		}
	 ...
	 *            <tr>
	 *            <td>expand</td>
	 *            <td><i>yes/no or numerical value like weight in
	 *            GridBagConstraints</td>
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>The expansion.</td>
	 *            </tr>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>The background color. A possible color for
	 *            {@link ColorConstants} or a RGB value like: '150;230;23'</td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>bgpaint</td>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>The height in pixels for component. Used in empty
	 *            rows.</td>
	 *            </tr>
	 *
	 *            <tr>
	 ...
	 *            <td>no</td>
	 *            <td>no</td>
	 *            <td>The width in pixels for component. Used in empty
	 *            rows.</td>
	 *            </tr>
	 *
	 *            <tr>
	 ...
	 *            <td></td>
	 *            <td>no</td>
	 *            <td>Path to source icon to extract a image and create a
	 *            <code>TexturePaint</code></td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>align</td>
	 ...
	 *            <td>center</td>
	 *            <td>no</td>
	 *            <td>The horizontal alignment. This parameters is only used if
	 *            the layout value is 'flow'.</td>
	 *            </tr>
	 *
	 *            <tr>
	 *            <td>visible</td>
		...
		if (manager != null) {
			if (this.visiblePermissions == null) {
				if ((this.attribute != null) && (this.parentForm != null)) {
					this.visiblePermissions = new FormPermission(this.parentForm.getArchiveName(), "visible", this.attribute.toString(), true);
				}
			}
			try {
				// Check to show
	...
	protected boolean checkEnabledPermission() {
		...
		if (manager != null) {
			if (this.enabledPermissions == null) {
				if ((this.attribute != null) && (this.parentForm != null)) {
					this.enabledPermissions = new FormPermission(this.parentForm.getArchiveName(), "enabled", this.attribute.toString(), true);
				}
			}
			try {
				// Check to show
