...
public class ApToolBarFiller extends Filler implements FormComponent, IdentifiedElement, SecureElement, Freeable, Transferable, DragGestureListener, DragSourceListener {
	 ...
	 *
	 * @param parameters
	 *            Parameter to initialize the component
	 */
	@Override
	...
	public DataFlavor[] getTransferDataFlavors() {
		try {
			return new DataFlavor[] { new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType + ";class=\"" + ApToolBarFiller.class.getName() + "\"") };
