...
public class JDescriptionPanel extends JPanel implements Internationalization {
	...
	public JDescriptionPanel(ResourceBundle bundle) {
		...
		this.add(this.lDescription, new GridBagConstraints(0, 0, 2, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(new JScrollPane(this.tDescription),
				new GridBagConstraints(0, 1, 2, GridBagConstraints.RELATIVE, 1, 1, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		this.add(this.tPrivate, new GridBagConstraints(0, 2, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(this.lPrivate,
				new GridBagConstraints(1, 2, GridBagConstraints.REMAINDER, 1, 1, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
	...
	public Vector getTextsToTranslate() {
		return new Vector(Arrays.asList(new String[] { JDescriptionPanel.ATTACH_DESCRIPTION, JDescriptionPanel.ATTACH_PRIVATE }));
	}
