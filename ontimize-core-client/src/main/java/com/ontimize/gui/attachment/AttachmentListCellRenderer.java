...
public class AttachmentListCellRenderer implements ListCellRenderer {
	...
	protected static void initIcons() {
		if (AttachmentListCellRenderer.initIcons) {
			...
			URL url = AttachmentListCellRenderer.class.getClassLoader().getResource(AttachmentListCellRenderer.DEFAULT_URI_PROP);
			if (url == null) {
				...
				try {
					...
					AttachmentListCellRenderer.unknownIcon = ApplicationManager.getIcon(AttachmentListCellRenderer.UNKNOWN_EXTENSION_ICON);
					AttachmentListCellRenderer.privateUnknownIcon = new CompoundIcon(AttachmentListCellRenderer.unknownIcon, AttachmentListCellRenderer.key);
	...
	public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
		...
		if (list instanceof AttachmentListPopup) {
			...
			if (this.component.getState() == AttachmentListCellRenderer.CHECK) {
				this.component.setToolTipText(ApplicationManager.getTranslation(AttachmentComponent.ATTACHMENT_PRIVATE_TIP, this.bundle));
				...
				this.component.setToolTipText(ApplicationManager.getTranslation(AttachmentListCellRenderer.EDIT_DESCRIPTION_TIP, this.bundle));
			} else {
