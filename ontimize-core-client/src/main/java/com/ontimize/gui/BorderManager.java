...
public class BorderManager {
	...
	static {
		BorderManager.putBorder(BorderManager.DEFAULT_TABLE_RENDER_BORDER_KEY, BorderFactory.createEmptyBorder(0, 5, 0, 0));
		...
		BorderManager.putBorder(BorderManager.DEFAULT_DATA_FIELD_REQUIRED_BORDER, new LineBorder(new Color(0x70c1dc), 1) {
