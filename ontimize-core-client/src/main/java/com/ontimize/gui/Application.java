...
/**
 *
 * Defines the methods that an application must implement. Those methods allows to interchange references among the application elements as well to perform the main operations the
...
public interface Application extends Internationalization {
	...
	/**
	 * Provides a reference to the ReferenceLocator configured to this application. The locator is set by the application constructor, and is mandatory to perform the login
	 * process.
	 *
	...
	/**
	 * Sets the EntityReferenceLocator for this application. The references locator is necessary to provide references to the Entity objects. The locator set will be unique for the
	 * whole application.
	 *
	 * @param locator
	 */
	 ...
	 *
	 * @param formManagerName
	 *            the name of the FormManager to show.
	 */
	 ...
	 *
	 * @param formManagerName
	 *            the FormManager class
	 * @param formManager
	 *            the name that will be use to register and reference the FormManager
	 */
	public void registerFormManager(String formManagerName, IFormManager formManager);

	/**
	 * Shows the application. This is the last method that is called before showing the application to the user. If some operations must be done before the application is loaded,
	 * this is the method that must be overwritten/implemented. For example, if the application must be sent to the tool bar just before to be showed, this is the method in which
	 * do that.
	 */
	public void show();
