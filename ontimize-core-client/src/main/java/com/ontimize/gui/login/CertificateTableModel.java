...
public class CertificateTableModel extends AbstractTableModel {
	...
	public String getColumnName(int column) {
		...
		if (column == 2) {
			return ApplicationManager.getTranslation(CertificateTableModel.CERTIFICATE_TABLE_MODEL_NOTBEFORE, this.bundle);
		}
		if (column == 3) {
			return ApplicationManager.getTranslation(CertificateTableModel.CERTIFICATE_TABLE_MODEL_NOTAFTER, this.bundle);
		}
		if (column == 4) {
			return ApplicationManager.getTranslation(CertificateTableModel.CERTIFICATE_TABLE_MODEL_SUBJECTDN, this.bundle);
		}
		return "";
	}
