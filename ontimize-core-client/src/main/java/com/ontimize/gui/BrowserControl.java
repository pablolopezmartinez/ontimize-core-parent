...
public class BrowserControl {
	 ...
	 *
	 * @since 5.2059EN <br>
	 *        This method detects by reflection whether exists class <code>java.awt.Desktop</code> is present and try to open URL/open mail client with method
	 *        <i>browse</i>/<i>mail</i> of class <code>java.awtDesktop</code>. In other case try to open url with runtime object.
	 *
	 * @param url
	 *            The URL of the file or the e-mail address
	 */
