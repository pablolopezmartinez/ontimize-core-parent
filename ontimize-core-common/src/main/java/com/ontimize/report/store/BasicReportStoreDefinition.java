...
public class BasicReportStoreDefinition implements ReportStoreDefinition {
	...
	public BasicReportStoreDefinition(String name, String dscr, String entity, String xmlDef, String sqlQuery, String type, ReportResource[] res, QueryExpression queryExpression) {
		this(null, name, dscr, entity, xmlDef, sqlQuery, type, res, queryExpression);
	}

	public BasicReportStoreDefinition(Object key, String name, String dscr, String entity, String xmlDef, String sqlQuery, String type, ReportResource[] res,
	...
	public String toString() {
		return "name: " + this.name + " , description: " + this.description + " , entity: " + this.entity + " , sql: " + this.sqlQuery + " , \nxml: " + this.xmlDefinition;
	}
}
