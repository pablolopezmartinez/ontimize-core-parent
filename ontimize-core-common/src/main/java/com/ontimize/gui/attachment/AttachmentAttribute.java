...
/**
 * This class creates a special attribute for attachments, which contains the
 * name of the attachment entity and the keys, in order to establish the
 * dispatcher that will be used when consulting the entity's attachments.
 */
public class AttachmentAttribute implements Serializable {
	 ...
	 *            Name of the entity
	 * @param formKeys
	 *            Keys of the form associated to the attachment
	 */
	 ...
	 *
	 * @param entityName
	 *            A {@link String} with the name of the attachment entity
	 */
