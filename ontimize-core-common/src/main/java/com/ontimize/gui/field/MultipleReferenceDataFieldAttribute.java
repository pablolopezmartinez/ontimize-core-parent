...
public class MultipleReferenceDataFieldAttribute implements Serializable {
	...
	public MultipleReferenceDataFieldAttribute(String attr, String entity, List cods, List typecods, List keys, List cols, List parentcods, List parentkeys) {
		this.attr = attr;
		this.cods = cods;
	...
	public boolean equals(Object o) {
		try {
			...
			return ((MultipleReferenceDataFieldAttribute) o).attr.equals(this.attr) && (this.hashCode() == o.hashCode());
		} catch (Exception ex) {
	 ...
	 *
	 * @param kv
	 * @return The same hashtable that the input parameter but using MultipleReferenceDataFieldAttribute.getCods() to replace the MultipleReferenceDataFieldAttribute attributes
	 */
