...
public interface RemotelyManageable extends Remote {
	 ...
	 * @param sessionId
	 *            int with the session id of the user's session.
	...
	/**
	 * Method that returns system information about the connection with the database. The keys to request information are stored into static variables in the class RemoteUtilities.
	 ...
	 *            String with the administrator id of the remote session.
	 * @param key
	 *            String indicating what information you wish to request.
	 * @return a <code>Hashtable</code> with the values.
	 * @throws Exception
	 */
	 ...
	 *
	 * @param nCharacters
	 *            int with the number of characters that will be recovered.
	 ...
	 *            String with the administrator id of the remote session.
	 * @param prop
	 *            The properties file to be established. This file will contain the structure of pair values: key-value.
	 * @throws Exception
	 */
