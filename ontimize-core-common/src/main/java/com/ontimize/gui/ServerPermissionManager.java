...
public interface ServerPermissionManager extends Remote {
	 ...
	 * @param permissionXML
	 *            XML value to describes the server permissions
	 * @return
	 * @throws Exception
	 */
	public EntityResult setServerPermissions(Hashtable keys, int sessionId, StringBuffer permissionXML) throws Exception;

	/**
	 * Get the permission definition for a specified profile
	 *
	 * @param profileKeys
	 *            Keys to identify a profile
	 * @param sessionId
	 *            User session identifier
	 * @return
	 * @throws Exception
	...
	public EntityResult setUserProfileServerPermissions(Hashtable profileKeys, StringBuffer permissions, int sessionId) throws Exception;
