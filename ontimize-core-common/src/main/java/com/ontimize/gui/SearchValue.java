...
public class SearchValue implements Serializable {
	...
	public SearchValue(int condition, Object value) {
		if ((condition != SearchValue.LESS) && (condition != SearchValue.EQUAL) && (condition != SearchValue.MORE) && (condition != SearchValue.LESS_EQUAL) && (condition != SearchValue.MORE_EQUAL) && (condition != SearchValue.NULL) && (condition != SearchValue.OR) && (condition != SearchValue.NOT_EQUAL) && (condition != SearchValue.BETWEEN) && (condition != SearchValue.IN) && (condition != SearchValue.NOT_IN) && (condition != SearchValue.EXISTS) && (condition != SearchValue.NOT_NULL) && (condition != SearchValue.NOT_BETWEEN)) {
