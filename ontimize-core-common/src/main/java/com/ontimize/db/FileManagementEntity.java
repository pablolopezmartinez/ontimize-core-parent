...
public interface FileManagementEntity extends Remote {
	...
	/**
	 * The file size is returned if it is known. Return -1 when it is an unknown value. Before calls this method the method prepareToTransfer must be called
	 *
	 * @param transferId
	 * @return
	 * @throws Exception
	 ...
	 * @param keys
	 * @param sessionId
	 * @return A random string identifying the transfer process. This identifier is used in the next requests for this file content
	 * @throws Exception
	 */
	 ...
	 * @param keys
	 * @param sessionId
	 * @return A random string identifying the transfer process. This identifier is used in the next requests to receive the bytes blocks
	 * @throws Exception
	 */
	...
	/**
	 * Gets a {@link BytesBlock} with the bytes from offset and with the specified length. Return null if it is the end of the file. The prepareToTransfer method must be called
	 * previously to get the 'transferId' value.
	 *
	 * @param transferId
	 * @param offset
	 * @param lenght
