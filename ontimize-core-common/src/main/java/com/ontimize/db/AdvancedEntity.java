...
public interface AdvancedEntity extends Entity {
	...
	/**
	 * @param kv
	 *            a <code>Hashtable</code> specifying conditions that must comply the set of records returned. Cannot be null.
	 * @param attributes
	 ...
	 * @param orderBy
	 *            a <code>Vector</code> of String or {@link SQLStatementBuilder.SQLOrder} objects in where the column orderer is established.
	 * @return
	 * @throws Exception
	 */
