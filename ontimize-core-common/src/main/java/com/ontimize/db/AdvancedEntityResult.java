...
/**
 * Extended <code>EntityResult</code> that adds information about number of records and index of first record of <code>ResultSet</code> contained. This object is returned in
 * {@link TableEntity#query(java.util.Hashtable, java.util.Vector, int, int, int, java.util.Vector) to allow that Table component is pageable.
 *
