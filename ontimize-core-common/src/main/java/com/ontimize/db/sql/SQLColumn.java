...
public class SQLColumn implements Serializable, Cloneable {
	...
	/**
	 * Creates a new <code>SQLColumn</code> indicating the name of the column, the SQL Type of it and the parameter primaryKey. If this parameter is true this column will be set as
	 * Primary Key.
	 *
	 * @param columnName
	 *            The name of the column.
	 ...
	 *            The int value to the SQL Type.
	 * @param primaryKey
	 *            The value of parameter primaryKey. If it is true the column will be set as Primary Key.
	 */
	...
	/**
	 * Creates a new <code>SQLColumn</code> indicating the name of the column, the SQL Type of it, the parameter primaryKey and the parameter required. If the parameter prikaryKey
	 * is true this column will be set as Primary Key. As well if the parameter required is true, the column will be set as Required, that is, it doesn't admit null values.
	 *
	 * @param columnName
	 *            The name of the column.
	 * @param columnSQLType
	 ...
	 *            The value of parameter primaryKey. If it is true the column will be set as Primary Key.
	 * @param required
	 *            The value of parameter required. If it is true the column will be set as Required (doesn't admit null values).
	 */
	 ...
	 *
	 * @param columnSQLType
	 *            An int with the SQL Type to this column.
	 */
	 ...
	 *
	 * @param primaryKey
	 *            A boolean that sets the value of the parameter primaryKey.
	 */
	 ...
	 *
	 * @param required
	 *            A boolean that sets the value of the parameter required.
	 */
	 ...
	 *
	 * @param columnSQLSize
	 *            int with the SQL size of the column.
	 */
	 ...
	 *
	 * @param unique
	 *            A boolean that sets the value of the parameter unique.
	 */
