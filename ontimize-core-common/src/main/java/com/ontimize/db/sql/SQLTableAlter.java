...
public class SQLTableAlter extends SQLTable {
	...
	/**
	 * Creates a new <code>SQLTableAlter</code> indicating the name of the table to be altered and the kind of operation to realize with the parameter add. If it is true the
	 * operation will be ADD and if the parameter is false the operation will be DROP.
	 *
	 * @param tableName
	 *            The name of the table.
	 * @param add
	 *            Value of the parameter add.
	 */
