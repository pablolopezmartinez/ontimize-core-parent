...
public class SQLTableCreation extends SQLTable {
	...
	/**
	 * The list of <code>SQLColum</code> with the columns that are going to be applied in the creation of the table
	 */
	protected List columns;

	/**
	 * The list of <code>SQLConstraint</code> with the constraints that are going to be applied in the creation of the table
	 */
	protected List constraints;

	/**
	 * Creates a new <code>SQLTableCreation</code> indicating the name of the constraint and the columns in where the constraint is applied.
	 *
	 * @param tableName
	 *            The name of the table
	 * @param columns
	 *            The list of columns that are going to be applied in the creation of the table
	 * @param constraints
	 *            The list of constraints that are going to be applied in the creation of the table
	 */
