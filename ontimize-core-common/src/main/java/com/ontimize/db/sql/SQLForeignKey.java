...
public class SQLForeignKey extends SQLConstraint {
	...
	/**
	 * This method returns the list of column/s of the referenced table that are going to be used into the constraint.<br>
	 *
	 ...
	 *            The table, in which the restriction is made,
	 * @param keys
	 *            Must contains a pair key-value, where key is the table column and value is the name of reference column.
	 */
	 ...
	 *
	 * @param secondaryTable
	 *            String with the name of the referenced table.
	 */
	...
	/**
	 * This method returns the SQL Statement to add a Foreign Key constraint to a database table. Returns a <code>String<code> with the SQL Statement
	 */
	@Override
