...
public class QueryExpression implements Serializable {
	...
	public boolean equals(Object e) {
		...
		if (e instanceof Expression) {
			...
			return this.expression.getLeftOperand().toString().equals(((Expression) e).getLeftOperand().toString()) && this.expression.getRightOperand().toString()
					.equals(((Expression) e).getRightOperand().toString()) && this.expression.getOperator().toString().equals(((Expression) e).getOperator().toString());
		} else {
			return false;
		}
	}
