...
public class WorkingDayIntervalOfMonth implements TimePeriod {
	...
	public boolean timeIsInPeriod(long time) {
		...
		int iDay = this.calendar.workingDayOfMonthToDayOfMonth(this.firstDay, this.cAux.get(Calendar.MONTH), this.cAux.get(Calendar.YEAR));
		int iLastDay = this.calendar.workingDayOfMonthToDayOfMonth(this.lastDay, this.cAux.get(Calendar.MONTH), this.cAux.get(Calendar.YEAR));
