...
public class XmlFilterQuery {
	...
	@XmlElement(required = true) protected XmlFilterQuery.Filters filters;
	 ...
	 *
	 * @param value
	 *            allowed object is {@link XmlFilterQuery.Filters }
	 *
	 */
	...
	public static class Filters {
		 ...
		 * {@link XmlFilterQuery.Filters.Filter }
		 *
		 *
		 */
		...
		public static class Filter {
			...
			@XmlElement(required = true) protected String key;
			 ...
			 *
			 * @param value
			 *            allowed object is {@link XmlFilterSearchValue }
			 *
			 */
