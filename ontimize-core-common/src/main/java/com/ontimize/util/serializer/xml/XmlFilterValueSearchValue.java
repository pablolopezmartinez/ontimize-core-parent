...
public class XmlFilterValueSearchValue {
	...
	@XmlAttribute protected String listtype;
	@XmlElement(name = "unique-value") protected Object uniqueValue;
	@XmlElement(name = "multiple-values") protected List<Object> multipleValues;
