...
public interface INoticeSystem extends Remote {
	...
	/**
	 * Method used to send notices. This method insert the notice in the notice entity and insert all destinies in the destiny notice entity <br>
	 *
	 * @param messageValues
	 * @param sessionId
	 * @param request
	 *            If this is true, the notices is a request notice. In this case the correct template must be selected
	 * @throws Exception
	 */
	 ...
	 * @param unsend
	 *            When this is true only return the unsend notices
	 * @param unread
	 *            When this is true ontly return the unread notices
	 * @return
	 * @throws Exception
	 */
	public EntityResult getInternalNotices(int sessionId, boolean unsend, boolean unread, boolean deleted) throws Exception;
	 ...
	 *            User session identifier
	 * @param deleted
	 *            deleted = true only query the deleted notices <br>
	...
	/**
	 * Get the identification of the user that must be stored in the notice system to identify this application user. In this way the identification of a user can be not only a
	 * string.
	 *
	 * @param sessionId
	 *            User session identifier
