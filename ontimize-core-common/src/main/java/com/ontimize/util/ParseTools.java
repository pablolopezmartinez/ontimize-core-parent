...
public class ParseTools {
	 ...
	 * 'tokenizer' actions. For example, <br>
	 * <br>
	 * s=
	 * "field1:equivalentfield1;field2:equivalentfield2;...;fieldn:equivalententfieldn"
	 * <br>
	 * separator1=";" <br>
	 * separator2=":" <br>
	 * <br>
	 ...
	 * @param separator2 Separator for second <code>Tokenizer</code> for each token
	 *                   obtained previously
	...
	/**
	 * Parses a String to convert it to a boolean. If the String value is 'yes' or
	 * 'true' the boolean response will be true, and if the String value is 'no' or
	 * 'false' the result will be false. If the String is not one of the previous
	 * one specified previously, the defaultValue will be returned.
	 *
	 ...
	 * This allows the developer to know the call hierarchy in each point.
	 *
	...
	/**
	 * Debug method that prints the thread methods from a determined
	 * {@link Throwable} object. This allows the developer to know the call
	...
	/**
	 * Returns a String containing the thread methods from the current execution
	 * point. This allows the developer to know the call hierarchy in each point.
	 *
	 * @param lines
	...
	/**
	 * Checks if a parameter is contained by a Hashtable (or by an extended class as
	 * {@link Properties})
	 *
	 * @param key  the parameter to check
	 * @param prop the Hashtable that contains the properties
	 * @return the value of the property if it is contained by the prop, or null if
	 *         the property is not in the Hashtable
	 */
