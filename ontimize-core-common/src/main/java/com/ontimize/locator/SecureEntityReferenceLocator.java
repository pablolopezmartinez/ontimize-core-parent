...
public interface SecureEntityReferenceLocator extends EntityReferenceLocator {
	...
	/**
	 * This method replaces to {@link EntityReferenceLocator#getEntityReference(String)} and gets entity references with security
	 *
	 * @param entity
	 *            Requested entity name
	 * @param user
	 *            Name of the user who is asking for the reference
	 * @param sessionId
	 *            Session identifier for the user who is asking the reference
