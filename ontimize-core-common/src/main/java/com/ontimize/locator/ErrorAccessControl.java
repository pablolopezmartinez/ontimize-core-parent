...
/**
 * This class is used to implement a login lock to users who have inserted their credentials wrong a specific number of times. This is used if in the locator.properties exist the
 * property "ControlAccessAttempts = true"
 *
 * This object stores a Hashtable whose keys are the usernames and the values the AccesObject associated with these users.
 *
 * @since 5.6.0
...
public class ErrorAccessControl {
	 ...
	 *
	 * @param user
	 *            The user who will be allowed access
	 */
	 ...
	 *
	 * @param user
	 *            The username of the AccessObject to be recovered.
	...
	/**
	 * Add an access attempt to the user which username is passed by param. If the attempts is more than numMaxErrorAccess in ErrorAccessControl, the user will be blocked.
	 *
	 * @param user
	 *            The user of the AccessObject to which you will add a new attempt.
	 */
	 ...
	 *
	 * @param user
	 *            The user of the object to which you will retrieve the last attempt
	 * @return True is the user number of attempts is more than numMaxErrorAcces in ErrorAccesControl, false otherwise
	 */
	...
	/**
	 * This object is the logic lock. This object contains a reference to the user, the last access attempt, the number of attempts and if the user is blocked or not.
	 *
	 * @author Imatia Innovation SL
	 * @since 5.6.0
	 */
	public class AccessObject {
		 ...
		 *
		 * @param lastAccess
		 *            The timestamps of the last unsuccessful access
		 */
		 ...
		 *
		 * @param block
		 *            A boolean to set the block state to user of this AccessObject
		 */
