...
public class FMPermission extends AbstractClientPermission {
	...
	public FMPermission(String idGF, String permissionName, String formName, boolean restricted, com.ontimize.util.calendar.TimePeriod period) {
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			if (this.name.equals(((FMPermission) o).getPermissionName()) && this.attr.equals(((FMPermission) o).getAttribute()) && this.fmId.equals(((FMPermission) o).getFMId())) {
