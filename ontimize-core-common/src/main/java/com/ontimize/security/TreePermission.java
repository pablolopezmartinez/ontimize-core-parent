...
public class TreePermission extends AbstractClientPermission {
	...
	public TreePermission(String tree, String permissionName, String nodeId, boolean restricted, com.ontimize.util.calendar.TimePeriod period) {
		this.tree = tree;
		this.name = permissionName;
		this.attr = nodeId;
		this.restricted = restricted;
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			if (this.name.equals(((TreePermission) o).getPermissionName()) && this.attr.equals(((TreePermission) o).getAttribute()) && this.tree
