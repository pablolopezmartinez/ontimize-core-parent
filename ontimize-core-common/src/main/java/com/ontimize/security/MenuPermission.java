...
public class MenuPermission extends AbstractClientPermission {
	...
	public MenuPermission(String permissionName, String componentAttr, boolean restricted, com.ontimize.util.calendar.TimePeriod period) {
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			if (this.name.equals(((MenuPermission) o).getPermissionName()) && this.attr.equals(((MenuPermission) o).getAttribute())) {
