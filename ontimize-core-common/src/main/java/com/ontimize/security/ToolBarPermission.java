...
public class ToolBarPermission extends AbstractClientPermission {
	...
	public ToolBarPermission(String permissionName, String componentAttr, boolean restricted, com.ontimize.util.calendar.TimePeriod period) {
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			if (this.name.equals(((ToolBarPermission) o).getPermissionName()) && this.attr.equals(((ToolBarPermission) o).getAttribute())) {
				return true;
			} else {
				return false;
			}
